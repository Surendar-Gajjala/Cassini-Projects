...
/**
 * Created by lakshmi on 07-07-2017.
 */

@Entity
@Table(name = "PDM_OBJECTPERMISSION")
@ApiObject(name = "PDM")
@JsonIgnoreProperties(ignoreUnknown = true)
public class PDMObjectPermission {
    ...
    @Type(type = "com.cassinisys.platform.util.EnumUserType", parameters = {@org.hibernate.annotations.Parameter(name = "enumClassName", value = "com.cassinisys.pdm.model.ObjectType")})
    ...
    @Type(type = "com.cassinisys.platform.util.EnumUserType", parameters = {@org.hibernate.annotations.Parameter(name = "enumClassName", value = "com.cassinisys.pdm.model.PermissionLevel")})
