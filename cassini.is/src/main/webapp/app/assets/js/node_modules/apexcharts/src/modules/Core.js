...
.
    style
.
    background = cnf.chart.background
...
.
    dom
.
    elGraphical = gl.dom.Paper.group().attr({
...
.
    dom
.
    elDefs = gl.dom.Paper.defs()

    gl
.
    dom
.
    elLegendWrap = document.createElement('div')
    gl
.
    dom
.
    ...
    if (w.globals.axisCharts) {
        ...
        if (
            ...
            if (
                ...
                isFinite(w.globals.maxX) && !w.globals.isBarHorizontal
            ) {
