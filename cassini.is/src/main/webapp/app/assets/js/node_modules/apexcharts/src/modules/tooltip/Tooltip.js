...
class Tooltip {
    ...
    drawTooltip(xyRatios) {
        ...
        if (
            ...
            ((w.config.chart.type === 'bar' || w.config.chart.type === 'rangeBar') && !this.tConfig.shared)
        ) {
    ...
    seriesHover(opt, e) {
        ...
        if (chartGroups.length) {
            chartGroups.forEach((ch) = > {
                ...
                if (ch.w.globals.minX === this.w.globals.minX &&
...
axisChartsTooltips({e, opt})
{
    ...
    if (
        Array.isArray(this.tConfig.enabledOnSeries) && !w.config.tooltip.shared
    ) {
...
deactivateHoverFilter()
{
    ...
    let allPaths = w.globals.dom.Paper.select(`.
    apexcharts - bar - area`)
