...
!function (t, e) {
    ...
    var w = void 0 !== this ? this : t, b = w.SVG = function (t) {
    ...
    b.did = 1e3, b.eid = function (t) {
        ...
        var t = e.getElementsByTagName("body")[0], i = (t ? new b.Doc(t) : b.adopt(e.documentElement).nested()).size(2, 0);
        b.parser = {
    ...
    b.PathArray = function (t, e) {
        ...
        toString: function () {
            ...
            if (!this.destination)return this;
            var e, i, n, r, s = this.value, o = this.destination.value, a = [], h = new b.PathArray;
            ...
            var n = [], s = new b.Point, o = new b.Point, a = 0, h = t.length;
            do {
        ...
        create: function (t) {
            ...
            animate: function (t, e, i) {
                ...
                var n = new b.Situation({duration: t || 1e3, delay: i || 0, ease: b.easing[e || "-"] || e});
                return this.queue(n), this
            }, delay: function (t) {
                var e = new b.Situation({duration: t, delay: 0, ease: b.easing["-"]});
                return this.queue(e)
            }, target: function (t) {
                ...
                for (t in n.animations)for (i = this.target()[t](), Array.isArray(i) || (i = [i]), Array.isArray(n.animations[t]) || (n.animations[t] = [n.animations[t]]), e = i.length; e--;)n.animations[t][e]instanceof b.Number && (i[e] = new b.Number(i[e])), n.animations[t][e] = i[e].morph(n.animations[t][e]);
        ...
        attr: function (t, e, i) {
            ...
            if (this.target()instanceof b.G)return this.transform({x: t}, e), this;
            var i = new b.Number(t);
            return i.relative = e, this.add("x", i)
        }, y: function (t, e) {
            if (this.target()instanceof b.G)return this.transform({y: t}, e), this;
            var i = new b.Number(t);
        ...
        }, inherit: b.Box, parent: b.Element, construct: {
            bbox: function () {
        ...
        }, inherit: b.Box, parent: b.Element, extend: {
            addOffset: function () {
        ...
        parent: b.Matrix, inherit: b.Transformation, create: function (t, e) {
        ...
        create: function (t) {
            ...
            if (t instanceof b.Element) {
                for (o = t, a = t, s = (t.attr("viewBox") || "").match(c), t.bbox, n = new b.Number(t.width()), r = new b.Number(t.height()); "%" == n.unit;)u *= n.value, n = new b.Number(o instanceof b.Doc ? o.parent().offsetWidth : o.parent().width()), o = o.parent();
                for (; "%" == r.unit;)l *= r.value, r = new b.Number(a instanceof b.Doc ? a.parent().offsetHeight : a.parent().height()), a = a.parent();
        ...
        var s = i.bind(n || t), o = t instanceof b.Element ? t.node : t;
        ...
        if (r.instance && ("function" != typeof i || (i = i._svgjsListenerId))) {
            ...
            (e || "").split(b.regex.delimiter).forEach(function (t) {
                var e, o, a = t && t.split(".")[0], h = t && t.split(".")[1];
    ...
    }), b.Defs = b.invent({create: "defs", inherit: b.Container}), b.G = b.invent({
        create: "g",
        inherit: b.Container,
        extend: {
            x: function (t) {
        ...
        create: "stop", inherit: b.Element, extend: {
            update: function (t) {
        ...
        create: "pattern", inherit: b.Container, extend: {
            fill: function () {
                return "url(#" + this.id() + ")"
            }, update: function (t) {
                return this.clear(), "function" == typeof t && t.call(this, this), this
        ...
        create: "symbol", inherit: b.Container, construct: {
            symbol: function () {
                return this.put(new b.Symbol)
            }
        }
    }), b.Use = b.invent({
        create: "use", inherit: b.Shape, extend: {
            element: function (t, e) {
        ...
        create: "rect", inherit: b.Shape, construct: {
            rect: function (t, e) {
                return this.put(new b.Rect).size(t, e)
            }
        }
    }), b.Circle = b.invent({
        create: "circle", inherit: b.Shape, construct: {
            circle: function (t) {
        ...
        create: "ellipse", inherit: b.Shape, construct: {
        ...
        create: "line", inherit: b.Shape, extend: {
            array: function () {
        ...
        create: "polyline", inherit: b.Shape, construct: {
            polyline: function (t) {
                return this.put(new b.Polyline).plot(t || new b.PointArray)
            }
        }
    }), b.Polygon = b.invent({
        create: "polygon", inherit: b.Shape, construct: {
            polygon: function (t) {
        ...
        morphArray: b.PointArray, x: function (t) {
        ...
        create: "path", inherit: b.Shape, extend: {
            morphArray: b.PathArray, array: function () {
        ...
        create: "image", inherit: b.Shape, extend: {
            load: function (e) {
                if (!e)return this;
        ...
        create: function () {
            ...
            x: function (t) {
                ...
                var t = (this.textPath && this.textPath() || this).node, e = b.utils.map(b.utils.filterSVGElements(t.childNodes), function (t) {
                    return b.adopt(t)
                });
                return new b.Set(e)
            }, rebuild: function (t) {
                if ("boolean" == typeof t && (this._rebuild = t), this._rebuild) {
                    var e = this, i = 0, n = this.dom.leading * new b.Number(this.attr("font-size"));
        ...
        create: "tspan", inherit: b.Shape, extend: {
            text: function (t) {
        ...
        plain: function (t) {
            ...
            var e = (this.textPath && this.textPath() || this).node, i = new b.Tspan;
        ...
        parent: b.Text,
        construct: {
            morphArray: b.PathArray, path: function (t) {
        ...
        }, inherit: b.Container, construct: {
            nested: function () {
                return this.put(new b.Nested)
            }
        }
    }), b.A = b.invent({
        create: "a", inherit: b.Container, extend: {
            to: function (t) {
        ...
        create: "marker", inherit: b.Container, extend: {
            width: function (t) {
