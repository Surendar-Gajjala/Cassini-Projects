...
class Radar {
    ...
    elPointsMain = null
        ...
        this
.
    yaxisLabels = this.graphics.group({
...
(
    ...
    let
    elSeries = this.graphics.group().attr({
        class: `apexcharts
-
    series`,
...
for (let p = 0; p < paths.linePathsTo.length; p++) {
    let renderedLinePath = this.graphics.renderPaths({
        ...
        pathFrom
:
    pathFrom === null ? paths.linePathsFrom[p] : pathFrom,
        pathTo
:
    paths.linePathsTo[p],
        strokeWidth
...
let renderedAreaPath = this.graphics.renderPaths({
    ...
    pathFrom
:
pathFrom === null ? paths.areaPathsFrom[p] : pathFrom,
    pathTo
:
paths.areaPathsTo[p],
    strokeWidth
