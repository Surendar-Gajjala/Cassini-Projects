...
static
extendArray(arrToExtend, resultArr)
{
    let extendedArr = []
...
static
hexToRgba(hex = '#999999', opacity = 0.6)
{
...
static
moveIndexInArray(arr, old_index, new_index)
{
...
isNumber(value)
{
    return (
        !isNaN(value) &&
        parseFloat(Number(value)) === value && !isNaN(parseInt(value, 10))
    )
}
