!function (t) {
    ...
    t.exports = {
        ...
        }, getTargetNode: d, getRelativeEventPosition: function (t, e) {
            if (t.pageX || t.pageY) var n = {x: t.pageX, y: t.pageY};
            var r = document.documentElement,
                a = (n = {x: t.clientX + r.scrollLeft - r.clientLeft, y: t.clientY + r.scrollTop - r.clientTop}, i(e));
    ...
    var n = i(0), r = (i(29), i(3)), a = i(1), s = function () {
        "use strict";
    ...
    t.exports = function (t) {
        ...
        return n(r, e), r.prototype.render = function (t) {
            var e,
                i = "<div class='gantt_cal_ltext' style='height:" + ((t.height || "23") + "px") + ";'><select style='width:100%;'>";
    ...
    var n = i(109), r = i(106), a = i(105), s = i(104), o = i(103), l = i(102), d = i(0), c = i(1), h = i(3);
        ...
        var r = {
            init: u, createEditors: function (n) {
                ...
                var a = [], s = null, ed = null, o = {
                    ...
                    init: function () {
                        var t = e.getMapping();
                        t.init && t.init(this, n), ed = s = n.$gantt.getDatastore(n.$config.bind);
                        var i = this;
                    ...
                    startEdit: function (t, e) {
                        if (this.isVisible() && this.save(), ed.exists(t)) {
                    ...
                    show: function (t, i) {
                        ...
                        if (o) {
                            var l = n.$getConfig().editor_types[o.type], d = r(a.id, a.columnName);
    ...
    var n = i(1), r = i(0), a = i(3), s = i(110), o = (i(12), function (t, e, i, n) {
    ...
    var n = i(22), r = i(0), a = i(3), s = i(23), o = function (t) {
    ...
    var n = i(22), r = i(0), a = i(3), s = function (t) {
    ...
    t.exports = function (t) {
        function e(e, a) {
            if (!t._isAllowedUnscheduledTask(e)) {
                var s = a.getItemPosition(e), o = a.$getConfig(), l = a.$getTemplates(), d = a.getItemHeight(),
                    c = t.getTaskType(e.type), h = Math.floor((t.config.row_height - d) / 2);
                c == o.types.milestone && o.link_line_width > 1 && (h += 1), c == o.types.milestone && (s.left -= Math.round(d / 2), s.width = d);
                var u = document.createElement("div"), _ = Math.round(s.width);
                ...
                var g = function (e, i, n, r) {
                    ...
                    if (t.getTaskType(l.type) == a.types.milestone ? s.push("gantt_milestone") : t.getTaskType(l.type) == a.types.project && s.push("gantt_project"), s.push("gantt_bar_" + t.getTaskType(l.type)), t.isSummaryTask(l) && s.push("gantt_dependent_task"), t.isSplitTask(l) && s.push("gantt_split_parent"), a.select_task && n == o.selected_task && s.push("gantt_selected"), n == o.drag_id && (s.push("gantt_drag_" + o.drag_mode), o.touch_drag && s.push("gantt_touch_" + o.drag_mode)), o.link_source_id == n && s.push("gantt_link_source"), o.link_target_id == n && s.push("gantt_link_target"), a.highlight_critical_path && t.isCriticalTask && t.isCriticalTask(l) && s.push("gantt_critical_task"), o.link_landing_area && o.link_target_id && o.link_source_id && o.link_target_id != o.link_source_id) {
                        var d = o.link_source_id, c = o.link_from_start, h = o.link_to_start,
                            u = t.isLinkAllowed(d, n, c, h), _ = "";
        ...
        return {
            refresh: function () {
                ...
                if (this.$config.rowStore && this.$gantt.$data.tasksStore) {
                    var t, e = this.$gantt.$data.tasksStore, i = this.$config.rowStore;
    ...
    var n = i(26), r = i(3), a = i(0), s = i(111), o = function (t, e, i, s) {
    ...
    o.prototype = {
        init: function (t) {
            ...
            if (this.$config.bind) {
                ...
                for (var r = this.$config.layers, a = 0; r && a < r.length; a++) {
                    "string" == typeof(d = r[a]) && (d = this.$gantt.$ui.layers[d]), "function" == typeof d && (d = {renderer: d}), d.host = this;
                    var s = n.addLayer(d);
            ...
            var n = this.$getConfig(), r = this.$gantt.$services.templates(), a = [], s = null, o = null, d = null;
            (t.template || t.date) && (o = t.template || this.$gantt.date.date_to_str(t.date));
            var c = 0, h = t.count;
            !n.smart_scales || isNaN(e) || isNaN(i) || (c = l(t.left, e), h = l(t.left, i) + 1), d = t.css || function () {
            }, !t.css && n.inherit_scale_class && (d = r.scale_cell_class);
            for (var u = c; u < h && t.trace_x[u]; u++) {
                s = new Date(t.trace_x[u]);
                var _ = o.call(this, s), f = t.width[u], g = t.height, p = t.left[u], v = "", m = "", y = "";
                if (f) {
            ...
            var o = this._tasks.trace_index_transition, d = a;
            if (!s) return o ? o[0] : 0;
    ...
    var n = i(2), r = i(1), a = (i(0), function (t) {
        ...
        return n(e, t), e.prototype.destructor = function () {
            ...
            for (var s = 0; s < this._sizes.length; s++) if (!(n = this.$cells[s]).$config.hidden) {
                ...
                var l = n.$view, d = this._xLayout ? "marginRight" : "marginBottom";
            ...
            (i = []).push([t.$container, n[0], function (i) {
                ...
                if (!a(i) && l) {
                    ...
                    if (!t._prevent_touch_scroll) {
                        if (u && c) {
                            var _ = c.pageX - u.pageX, g = c.pageY - u.pageY;
                ...
                if (!a(i)) {
                    ...
                    if (s && s.on_mouse_up(n), u && (t.refreshTask(t.locate(u)), u.parentNode && (u.parentNode.removeChild(u), t._touch_feedback())), t._touch_scroll_active = l = d = !1, u = null, c && o) {
                        var _ = new Date;
                        if (_ - o < 500) t.$services.getService("mouseEvents").onDoubleClick(c), f(i); else o = _
                    } else o = new Date
                }
            }]);
    ...
    t.exports = function (t) {
        ...
        return n(r, e), r.prototype.render = function (i) {
            var n = t.config.types, r = t.locale.labels, a = [], s = i.filter || function () {
                return !0
            };
            for (var o in n) !1 == !s(o, n[o]) && a.push({key: n[o], label: r["type_" + o]});
            i.options = a;
            var l = i.onchange;
    ...
    t.exports = function (t) {
        ...
        return n(r, e), r.prototype.render = function (e) {
            ...
            var o, l, d, c, h = r, u = e.getElementsByTagName("select"), _ = e.getElementsByTagName("input"), f = _[1],
                g = [_[0], _[2]], p = e.getElementsByTagName("span")[0], v = r._time_format_order;
            ...
            }, this), f.onchange = t.bind(m, this), "string" == typeof(o = t._resolve_default_mapping(r)) && (o = {start_date: o}), l = n[o.start_date] || new Date, d = n[o.end_date] || t.calculateEndDate({
                start_date: l,
                duration: 1,
                task: n
    ...
    t.exports = function (t) {
        var e = i(1), n = i(5), r = i(54)(t), a = i(53)(t), s = i(52)(t), o = i(10)(t), l = i(51)(t), d = i(50)(t),
            c = i(49)(t), h = i(48)(t);
        ...
        t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t.$services.getService("state").registerProvider("lightbox", function () {
            ...
            getTimePicker: function (e, i) {
                ...
                for (e._time_format_order = {size: 0}, t.config.limit_time_select && (d.first = 60 * l.first_hour, d.last = 60 * l.last_hour + 1, d.date.setHours(l.first_hour)), r = 0; r < d.timeFormat.length; r++) r > 0 && (o += " "), (a = _(e, r, d)) && (s = t._waiAria.lightboxSelectAttrString(d.timeFormat[r]), o += "<select " + (e.readonly ? "disabled='disabled'" : "") + (i ? " style='display:none' " : "") + s + ">" + a + "</select>");
                return o
            },
    ...
    t.exports = function (t) {
        t.isUnscheduledTask = function (t) {
            ...
            var i = this.getTask(e), n = (this.getTaskType(i.type), i.start_date ? i.start_date.valueOf() : null),
            ...
            var r, a, s, o = e.date, l = e.step, d = e.unit;
            if (!i) return o;
            if (d == i.unit && l == i.step && +o >= +i.min_date && +o <= +i.max_date) s = Math.floor(t.columnIndexByDate(o)), i.trace_x[s] || (s -= 1, i.rtl && (s = 0)), a = new Date(i.trace_x[s]), r = t.date.add(a, l, d); else {
    ...
    var n = i(62), r = i(59), a = i(57), s = i(0);
    t.exports = function (t) {
    ...
    t.exports = function (t) {
        ...
        function s(e) {
            e = e.id ? e.id : e;
            var i = t.getTask(e), n = t.config.types, r = t.hasChild(i.id) ? n.project : n.task,
    ...
    function i(t) {
        ...
        function r(n, r, a, s) {
            ...
            return e[o] ? e[o] : e[o] = function (e, n, r, a) {
                for (var s = i(e, n), o = r.unit, l = {}, d = 0; d < s.length; d++) for (var c = s[d], h = t.date[o + "_start"](new Date(c.start_date)); h < c.end_date;) {
                    var u = h;
                    if (h = t.date.add(h, 1, o), t.isWorkTime({date: u, task: c, unit: o})) {
                        var _ = u.valueOf();
                        l[_] || (l[_] = []), l[_].push(c)
                    }
                }
    ...
    var n = i(1);
    t.exports = function (t) {
        var e = 50, i = 30, r = 10, a = 50, s = null, o = !1, l = null, d = {started: !1}, c = {};
        ...
        function g(e) {
            ...
            c = {x: e.clientX, y: e.clientY}, !s && i && f(!0)
        }

        function p() {
            if (!u()) return f(!1), !1;
            var e = n.getNodePosition(h()), r = c.x - e.x, a = c.y - e.y, s = o ? 0 : v(r, e.width, d.x - e.x),
                l = v(a, e.height, d.y - e.y), _ = t.getScrollState(), g = _.y, p = _.inner_height, m = _.height,
                y = _.x, k = _.inner_width, b = _.width;
        ...
        setTransactionMode: function (t, e) {
            ...
            if (t) {
                ...
                if ("GET" == this._tMode) r.query({
                    ...
                    var c = this.getState(e), h = a.replace(/(\&|\?)editing\=true/, ""), u = (l = "", "post");
            ...
            if (this.updatedRows.length) {
                ...
                if (this._tSend) this._sendData(this._getAllData()); else for (e = 0; e < this.updatedRows.length; e++) if (!this._in_progress[this.updatedRows[e]]) {
    ...
    t.exports = function (t) {
        ...
        t._dp_init = function (o) {
            t.assert(!this._dp, "The dataProcessor is already attached to this gantt instance"), o.setTransactionMode("POST", !0), o.serverProcessor += (-1 != o.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", o._serverProcessor = o.serverProcessor, o.$gantt = this, o.styles = {
                ...
                error: "gantt_error",
                clear: ""
            }, o._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"], function (t, i) {
                ...
                s.push(this.attachEvent("onTaskIdChange", function (i, n) {
                    if (e._waitMode) {
                        ...
                        if (d.length) for (l = l || {}, a = 0; a < d.length; a++) {
    ...
    var n = i(0), r = i(85), a = i(84), s = i(23), o = i(21), l = i(83), d = i(82);
    ...
    t.exports = function (t) {
        ...
        s.attachEvent("onBeforeRefreshAll", function () {
            ...
            c(t.mixin({id: e}, t.$data.linksStore.getItem(i))), d(t.$data.linksStore.getItem(i))
                ...
                this._legacyGridResizerClass(e), e.attachEvent("onBeforeResize", function () {
                    ...
                    if (a) {
                        ...
                        if (a.$config.hidden = a.$parent.$config.hidden = !s, !a.$config.hidden) {
                            ...
                            } else a.$parent._setContentSize(a.$config.width, a.$config.height); else r && n.isChildOf(r.$task, e.$view) && (a.$config.original_grid_width = t.config.grid_width), i || (a.$parent.$config.width = 0)
                        }
                        i = !1
                    }
                }), t._getVerticalScrollbar = this.getVerticalScrollbar, t._getHorizontalScrollbar = this.getHorizontalScrollbar;
                var r = this.getVerticalScrollbar(), a = this.getHorizontalScrollbar();
    ...
    var n = i(1), r = function (t, e) {
        ...
        var d = e.$services, c = d.getService("state"), h = d.getService("dnd");
        ...
        u.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
            ...
            var d = u.config, c = u.getPosition(o);
            !function (t, e) {
                t.style.left = e.x + 5 + "px", t.style.top = e.y + 5 + "px"
            }(d.marker, c);
            var h = !!n.locateClassName(o, "gantt_link_control"), g = r, v = i, m = a, y = e.locate(o), k = !0;
            ...
            var S = !(v == h && g == y && m == k);
            return S && (g && e.refreshTask(g, !1), y && e.refreshTask(y, !1)), S && f(d.marker), function (i, n, r, a) {
                var s = function () {
                    u._direction || (u._direction = document.createElement("div"), t.$task_links.appendChild(u._direction));
                    return u._direction
                }(), o = l(), d = ["gantt_link_direction"];
                ...
                s.className = d.join(" ");
                var h = (a - n) / (r - i), _ = Math.atan(h);
                2 == p(i, r, n, a) ? _ += Math.PI : 3 == p(i, r, n, a) && (_ -= Math.PI);
                var f = Math.sin(_), g = Math.cos(_), v = Math.round(n), m = Math.round(i),
                        ...
                        return {
                            ...
                            _update_on_move: function (i) {
                                ...
                                if (a.mode) {
                                    ...
                                    var d = o.x - a.start_x, c = e.getTask(a.id);
                            ...
                            on_mouse_down: function (i, r) {
                                if (2 != i.button || void 0 === i.button) {
                                    ...
                                    if (e.isTaskExists(s) && (o = e.getTask(s)), !e.isReadonly(o) && !this.drag.mode) {
                                        ...
                                        var l = n.getClassName(r), d = this._get_drag_mode(l, r);
    ...
    var n = i(0), r = i(92), a = i(91), s = i(1), o = function (t) {
        var e = t.$services;
        return {
            onCreated: function (e) {
                var s = e.$config;
        ...
        init: function (t, e) {
            ...
            if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                ...
                t.defined(e.$getConfig().dnd_sensitivity) && (r.config.sensitivity = e.$getConfig().dnd_sensitivity), r.attachEvent("onBeforeDragStart", t.bind(function (i, n) {
                    ...
                    var l = o.getAttribute(e.$config.item_attribute), d = s().getItem(l);
                    ...
                    var l = s(), d = l.getItem(r.config.id);
                    ...
                    var d = l.getItem(r.config.id), c = r._getTargetY(i), h = r._getTaskByY(c, l.getIndexById(d.id));
                    ...
                    if (l.exists(h) || (h = r.lastTaskOfLevel(o.order_branch_free ? d.$level : 0)) == r.config.id && (h = null), l.exists(h)) {
                        ...
                        if (l.getIndexById(_.id) * o.row_height + o.row_height / 2 < c) {
                            var f = l.getIndexById(_.id), g = l.getNext(_.id), p = l.getItem(g);
                            if (p) {
                        ...
                        for (var v = l.getIdByIndex(f - 1), m = l.getItem(v), y = 1; (!m || m.id == _.id) && f - y >= 0;) v = l.getIdByIndex(f - y), m = l.getItem(v), y++;
                        if (d.id == _.id) return;
    ...
    var n = i(0), r = i(94), a = (i(12), function (t) {
        return {
            onCreated: function (e) {
                e.$config = n.mixin(e.$config, {bind: "task"}), "grid" == e.$config.id && (this.extendGantt(e), t.ext.inlineEditors = t.ext._inlineEditors.createEditors(e), t.ext.inlineEditors.init()), this._mouseDelegates = i(11)(t)
            }, onInitialized: function (e) {
    ...
    t.exports = function (t) {
        return function (e, i) {
            ...
            for (var l = [], d = 0; d < r.length; d++) {
                var c, h, u, _ = d == r.length - 1, f = r[d];
                ...
                var g = "gantt_cell" + (_ ? " gantt_last_cell" : ""), p = [];
                if (f.tree) {
    ...
    t.exports = function (t) {
        var e = {
            ...
            path: [], clear: function () {
                ...
                var d = 2 * a.link_arrow_size, c = this.get_line_type(i, n.$getConfig()), h = r.e_x > r.x;
                if (c.from_start && c.to_start) this.point_to(l.left, d), h ? (this.point_to(l.down, s), this.point_to(l.right, o)) : (this.point_to(l.right, o), this.point_to(l.down, s)), this.point_to(l.right, d); else if (!c.from_start && c.to_start) if (h = r.e_x > r.x + 2 * d, this.point_to(l.right, d), h) o -= d, this.point_to(l.down, s), this.point_to(l.right, o); else {
                    o -= 2 * d;
                    var u = s > 0 ? 1 : -1;
        ...
        return function (n, r) {
            ...
            var l = i.get_points(n, r), d = e.get_lines(l, r), c = document.createElement("div"), h = "gantt_task_link";
            ...
            var g = d[d.length - 1].direction, p = function (t, i, n) {
                var r = n.$getConfig(), a = document.createElement("div"), s = t.y, o = t.x, l = r.link_arrow_size,
                    d = r.row_height, c = "gantt_link_arrow gantt_link_arrow_" + i;
                switch (i) {
                    case e.dirs.right:
                        s -= (l - d) / 2, o -= l;
                        break;
    ...
    var n = i(0), r = i(27), a = i(25), s = i(2), o = function (t) {
        function e(e, i, n, r) {
    ...
    var n = i(1), r = i(0), a = i(25), s = i(13), o = i(2), l = function (t) {
        function e(e, i, n, r) {
    ...
    t.exports = function (t) {
        var e = i(8)(t), n = i(0), r = "%Y-%m-%d", a = null, s = null;
        ...
        init: function (t, e) {
            ...
            a.attachEvent("onBeforeFocus", function (e) {
                ...
                var s = t.locateCell(r.target), o = !!s && t.getEditorConfig(s.columnName), l = t.getState(),
                    d = n.constants.KEY_CODES, c = r.keyCode, h = !1;
                switch (c) {
                    case d.ENTER:
    ...
    t.exports = function (t, e) {
        var i = {
            column_before_start: t.bind(function (t, i, r) {
                ...
                var s = e.$getConfig(), o = i.config, l = e.getGridColumns(), d = parseInt(o.drag_index, 10), c = l[d],
                    h = n.getNodePosition(e.$grid_scale), u = parseInt(o.marker.style.left, 10),
                    _ = c.min_width ? c.min_width : s.min_grid_column_width, f = e.$grid_data.offsetWidth, g = 0, p = 0;
                ...
                if (d.max_width && d.max_width < h && (h = d.max_width), !1 !== e.callEvent("onColumnResizeEnd", [l, d, h]) && d.width != h) {
                    if (d.width = h, a.keep_grid_width) o = a.grid_width; else {
                        c = l;
    ...
    var n = i(0), r = i(9), a = function (t, e) {
        ...
        function l(t, e, i) {
            ...
            return function (t, e, i, n, a, s) {
                ...
                for (var d = 1 * s.rightBorderWidth, c = r(s.rightBorderColor), h = 0, u = 0, _ = 0, f = 1; f <= n; f++) for (h = f * e - 1, _ = 0; _ < d; _++) for (u = 0; u < t * i; u++) l(h - _, u, c, o);
                var g = 1 * s.bottomBorderWidth, p = r(s.bottomBorderColor);
                u = 0;
                for (var v = 1; v <= i; v++) for (u = v * t - 1, _ = 0; _ < g; _++) for (h = 0; h < e * n; h++) l(h, u - _, p, o);
        ...
        return {
            render: function (t, i, r, c) {
                if (i.static_background && document.createElement("canvas").getContext) {
                    ...
                    }(t), i, r), i, r, c), u = document.createDocumentFragment();
    ...
    var n = i(2), r = i(1), a = i(0), s = i(9), o = (i(3), function (t) {
        "use strict";
        ...
        return n(e, t), e.prototype.init = function (t) {
            ...
            for (var t, e = 0, i = 0, n = this._isHorizontal(), r = this._getLinkedViews(), a = n ? "scrollWidth" : "scrollHeight", s = n ? "contentX" : "contentY", o = n ? "x" : "y", l = this._getScrollOffset(), d = 0; d < r.length; d++) if ((t = r[d]) && t.$content && t.$content.getSize && !t.$config.hidden) {
    ...
    var n = i(2), r = i(28), a = i(6), s = function (t) {
        "use strict";
                ...
                var l = {
                    tempCollection: [], renderers: {}, container: i, filters: [], getLayers: function () {
                        ...
                        for (var i = this.container(), s = this.tempCollection, o = 0; o < s.length; o++) if (t = s[o], this.container() || t && t.container && a.isChildOf(t.container, document.body)) {
                            var l = t.container, d = t.id, c = t.topmost;
                            if (!l.parentNode) if (c) i.appendChild(l); else {
    ...
    var n = function (t) {
        return function (e) {
            ...
            return {
                ...
                }, onDoubleClick: l, onMouseMove: d, onContextMenu: a, onClick: r, destructor: function () {
                    h(), i = null, c = null
                }
            }
        }
    ...
    var n = i(122), r = i(120), a = i(119), s = i(6), o = i(28), l = i(116), d = i(115), c = i(114), h = i(113),
        u = i(27), _ = i(13), f = i(101), g = i(100), p = i(12), v = i(24), m = i(99), y = i(98), k = i(97), b = i(96),
        $ = i(95), x = i(93), w = i(90);
    t.exports = {
        init: function (t) {
            function e(e, i) {
            ...
            return t.ext.inlineEditors = T, t.ext._inlineEditors = T, T.init(t), {
                ...
                layersApi: S.init(),
                render: {gridLine: b(t), taskBg: y(t), taskBar: v(t), taskSplitBar: m(t), link: k(t)},
                layersService: {
                    getDataRender: function (e) {
    ...
    t.exports = function (t) {
        ...
        function c(i, c, h) {
            var u = i.tagName ? i : function (i, s, o) {
                var c = document.createElement("div"), h = (t.locale, n.uid());
