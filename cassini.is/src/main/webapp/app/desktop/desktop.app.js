define([
        ...
        'app/desktop/modules/media/projectMedia.module',
        'app/desktop/modules/tm/tm.module',
        'app/desktop/modules/im/im.module',
        'app/desktop/modules/issues/issues.module',
        'app/desktop/modules/site/sites.module',
        'app/desktop/modules/proc/proc.module',
        'app/desktop/modules/col/col.module',
        'app/desktop/modules/reporting/reporting.module',
        ...
        'app/desktop/modules/subContracts/contracts.module',
        'app/desktop/modules/stores/details/storeDetails.module',
