<div>
    ...
    <div>
        <div class="text-right type-selector">
            <div class="dropdown dropdown-append-to-body">
                ...
                <ul id="dropdownMenu" class="dropdown-menu custom-dropdown" aria-labelledby="dropdownMenuButton"
                    ...
                    <li ng-repeat="oType in propsVm.objectTypes | orderBy : 'label' ">
        ...
        <div ng-if="propsVm.selectedType == null" style="text-align: center;">
            <h3 style="color: lightgrey">Select an object type</h3>
        </div>
        <div class="flex-row flex-row-center" ng-if="propsVm.selectedType != null">
            <div id="propAddButton"
                 title="New Property" ng-if="hasPermission('permission.settings.addCustomProperties')"
            ...
            <div id="property{{$index}}" class="flex-col prop-container" ng-repeat="prop in propsVm.properties">
                <div id="propertyMask{{$index}}" class="prop-container-mask centered-container">
                    <div class="centered-child">
                        ...
                        <div>
                            <button class='btn btn-xs btn-default' ng-click='propsVm.hideMask($index)'>No</button>
                            <button class='btn btn-xs btn-danger' ng-click='propsVm.deleteProperty(prop)'>Yes</button>
                        </div>
                    </div>
                </div>
                <div class="prop-header">
                    ...
                    <div ng-if="prop.editMode" style="display: flex">
                        ...
                        <div class="buttons" style="display: inline-block; margin-left: -35px;">
                            <i title="Save Changes" class="fa fa-check mr10" ng-click="propsVm.applyChanges(prop)"></i>
                            <i title="Cancel Changes" class="fa fa-times"
                               ng-click="propsVm.cancelChanges(prop);prop.editMode = false;prop.required = false"></i>
                        </div>
                    </div>
                    <div class="buttons" ng-if="!prop.editMode">
                        <i title="Edit property" class="fa fa-edit mr10" ng-click="propsVm.editProperty(prop)"
                           ng-if="hasPermission('permission.settings.editCustomProperties')"></i>
                        <i title="Delete property" class="fa fa-times"
                           ng-if="hasPermission('permission.settings.deleteCustomProperties')"
                ...
                <div class="prop-body" id="prop-body{{$index}}">
                    ...
                    <div class="dropdown dropdown-append-to-body form-row">
                        <span class="text-small text-muted" translate>Data Type</span> :
                        <span type="button" id="dropdownMenuButton{{$index}}"
                            ...
                            <span ng-if="prop.newDataType == null" translate>select data type</span>
                        ...
                        <ul ng-if="prop.dataTypeMode" id="dropdownMenu{{$index}}" class="dropdown-menu prop-dropdown"
                            ...
                            <li ng-repeat="dType in propsVm.dataTypes | orderBy">
                         ...
                         <span ng-if="prop.newDataType == 'OBJECT'" type="button" id="dropdownMenuButton1{{$index}}"
                               ...
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span ng-if="prop.newRefType != null">{{prop.newRefType}}</span>
                            <span ng-if="prop.newRefType == null">Ref Type</span>
                        ...
                        <ul ng-if="prop.refTypeMode && prop.newDataType == 'OBJECT'" id="dropdownMenu1{{$index}}"
                            ...
                            <li ng-repeat="refType in propsVm.refTypes | orderBy">
