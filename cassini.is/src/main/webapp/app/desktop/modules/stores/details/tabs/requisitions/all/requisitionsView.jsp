    ...
    <div>
        <div class="responsive-table" style="overflow: auto;">
            <table class="table table-striped highlight-row">
                <thead>
                <tr>
                    <th style="min-width: 150px;">Requisition Number</th>
                    <th style="min-width: 150px;">Project</th>
                    <th style="min-width: 150px;">Requested Date</th>
                    <th style="min-width: 150px;">RequestedBy</th>
                    <th style="min-width: 150px;">Status</th>
                    <th style="min-width: 150px;">ApprovedBy</th>
                    <th style="min-width: 150px;">Notes</th>
                    <th style="min-width: 150px;" ng-repeat="reqObjectAttribute in requestsVm.requiredObjectAttributes">
                        {{reqObjectAttribute.name}}
                    </th>

                    <th style="min-width: 150px;" class='added-column'
                        ng-repeat="objectAttribute in requestsVm.objectAttributes">
                        {{objectAttribute.name}}
                        <i class="fa fa-times-circle" style="cursor: pointer;"
                           ng-click="requestsVm.removeAttribute(objectAttribute)"
                    ...
                    <td colspan="12">
                        <span style="font-size: 15px;">
                            <img src="app/assets/bower_components/cassini-platform/images/loaders/loader19.gif"
                                 class="mr5">Loading Requisitions..
                        </span>
                    </td>
                </tr>
                <tr ng-if="requestsVm.requisitions.content.length == 0 && !requestsVm.loading">
                    <td colspan="25">No Items are available to view</td>
                </tr>
                <tr data-ng-repeat="item in requestsVm.requisitions.content" ng-if="requestsVm.loading == false">
                    <td><a href=""
                           ng-click="requestsVm.showRequisitionDetails(item)" title="Click to show details">
                        <span>{{item.requisitionNumber}}</span></a>
                    </td>
                    ...
                    <td class="added-column" ng-repeat="objectAttribute in requestsVm.requiredObjectAttributes">
                            ...
                            <div class="attributeTooltiptext">
                                <ul>
                                    <li ng-repeat="attachment in item[attrName]">
                                        <a href="" ng-click="requestsVm.openAttachment(attachment)"
                        ...
                        <div ng-if="objectAttribute.name != 'modifiedBy' && objectAttribute.name != 'createdBy'
                             ...
                             ng-init="attrName = objectAttribute.name">
                            <a href="" ng-click="requestsVm.showImage(item[attrName])"
                            ...
                            <div id="reqModal" class="img-model modal" style="z-index: 11">
                                <span class="closeImage">&times;</span>
                                <img class="modal-content" id="reqImg">
                            </div>
                    ...
                    <td class="added-column" ng-repeat="objectAttribute in requestsVm.objectAttributes">
                        ...
                        <div ng-if="objectAttribute.name != 'modifiedBy' && objectAttribute.name != 'createdBy'
                                        && objectAttribute.dataType != 'CURRENCY' && objectAttribute.dataType == 'IMAGE'"
                             ng-init="attrName = objectAttribute.name">
                            <a href="" ng-click="requestsVm.showRequiredImage(item[attrName])"
                               title="Click to show large Image">
                                <img ng-if="item[attrName] != null"
                                     ng-src="{{item[attrName]}}"
                                     style="height: 30px;width: 40px;margin-bottom: 5px;">
                            ...
                            <div id="reqModal1" class="img-model modal" style="z-index: 11">
                                <span class="closeImage11">&times;</span>
                                <img class="modal-content" id="reqImg1">
                            </div>
