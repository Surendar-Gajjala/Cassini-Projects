define(
    ...
    function (module) {
        module.directive('issueTypeTree', ['$compile', '$timeout', 'ClassificationService', function ($compile, $timeout, ClassificationService) {
            return {
                templateUrl: 'app/desktop/modules/stores/details/tabs/issues/directive/issueTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '='
                ...
                link: function ($scope, elm, attr) {
                    ...
                    function initIssueTypeTree() {
                        classificationTree = $('#issueTypeTree').tree({
                            data: [
                                {
                                    id: nodeId,
                                    text: 'IssueType',
