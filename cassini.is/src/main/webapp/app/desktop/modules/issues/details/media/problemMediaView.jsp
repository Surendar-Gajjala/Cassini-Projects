...
<div id="problemDropzoneForm">
    <div style="font-style: italic; text-align: center;margin-bottom: 10px;margin-top: 10px;"
         ng-hide="selectedProject.locked || !(hasPermission('permission.issues.assign') || login.person.isProjectOwner)">
        Drag and drop files here or <a href="" ng-click="problemMediaVm.selectFiles()">(Click here to
        upload
        files)</a>
    </div>
    <div id="problemMediaContainer" class="row" ng-repeat="media in problemMediaVm.problemMedia">
        <div class="col-sm-3 image" ng-repeat="file in media">
            ...
            <div id="myModal2" class="img-model model">
                ...
                <span id="problemImg"><img class="model-content" id="img03"></span>

                <a href="" class="rightArrow" ng-click="next()"><i class="fa fa-arrow-circle-right"></i>
                </a>

                <div ng-if="problemMediaVm.selectedImage.location.uploadFrom != 'null' " class="uploadBy">Uploaded from
                    :
                    {{problemMediaVm.selectedImage.location.uploadFrom}}
                </div>
                <span class="print" ng-click="print()" title="Print"><i class="fa fa-print"></i></span>
