...
<div ng-if="receiveTypeVm.receiveType == null || receiveTypeVm.receiveType == undefined" style="padding: 10px">
    <span>No Receive Type selected to see/edit details</span>
</div>
<div ng-if="receiveTypeVm.receiveType != null" <%--style="overflow-y: auto;overflow-x: hidden"--%>>
    <div class="typeInfo">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7" ng-if="hasPermission('permission.masterdata.editClassification')==false"
                             style="margin-top: 3px;padding-top: 7px;">{{receiveTypeVm.receiveType.name}}
                        </div>
                        <div class="col-sm-7" ng-if="hasPermission('permission.masterdata.editClassification')==true">
                            <input type="text" class="form-control" name="title"
                                   ng-model="receiveTypeVm.receiveType.name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7" ng-if="hasPermission('permission.masterdata.editClassification')==false"
                             style="margin-top: 3px;padding-top: 7px;">{{receiveTypeVm.receiveType.description}}
                        </div>
                        <div class="col-sm-7" ng-if="hasPermission('permission.masterdata.editClassification')==true">
                            <textarea name="description" rows="5" class="form-control" style="resize: none"
                                      ng-model="receiveTypeVm.receiveType.description"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <ui-select ng-model="receiveTypeVm.receiveType.receiveNumberSource" theme="bootstrap"
                                       ng-disabled="hasPermission('permission.masterdata.editClassification')==false"
                                       style="width:100%">
                                <ui-select-match placeholder="Select">{{$select.selected.name}}</ui-select-match>
                                <ui-select-choices
                                        repeat="source in receiveTypeVm.autoNumbers | filter: $select.search">
        ...
        <br>
        <h4 class="section-title" ng-show="receiveTypeVm.attributesShow">Attributes</h4>
        <br>

        <div class="row" ng-show="receiveTypeVm.attributesShow">
            <div style="margin-left: 10px;">
                <div>
                    <button class="btn btn-xs btn-primary" ng-click="receiveTypeVm.addAttribute()">New Attribute
                    </button>
                    <span style="margin-left: 249px; color: red;">{{receiveTypeVm.error}}</span>
                </div>
                <div class="responsive-table">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <tr ng-if="receiveTypeVm.receiveType.attributes.length == 0">
                            <td colspan="7">No attributes</td>
                        </tr>
                        <tr ng-repeat="attribute in receiveTypeVm.receiveType.attributes">
                            ...
                            <td class="text-center">
                                    ...
                                    <ul uib-dropdown-menu class="dropdown-menu dropdown-menu-right" role="menu"
                                        ...
                                        <li ng-click="receiveTypeVm.editAttribute(attribute)"
                                            ng-if="attribute.showValues == true">
                                            <a title="Edit" type="button"
                                               ng-disabled="attribute.itemType != receiveTypeVm.receiveType.id"
                                               class="dropdown-item">
                                                <span style="padding-left: 3px;">Edit</span>
                                            </a>
                                        </li>
                                        <li ng-click="receiveTypeVm.deleteAttribute(attribute)"
                                            ng-if="attribute.showValues == true">
                                            <a title="Delete"
                                               type="button"
                                               ng-disabled="attribute.itemType != receiveTypeVm.receiveType.id"
