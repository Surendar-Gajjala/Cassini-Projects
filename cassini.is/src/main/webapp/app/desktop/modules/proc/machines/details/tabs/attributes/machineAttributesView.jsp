...
<div class="item-details" style="padding: 30px;margin-left: 0;">
    <div ng-if="machineAttributeVm.attributes.length == 0 && machineAttributeVm.loading == false">
        <span translate>No Attributes are available to view</span>
    </div>
    <div class="row master-att" ng-if="machineAttributeVm.attributes.length != 0"
         ng-repeat="attribute in machineAttributeVm.attributes">
        ...
        <div class="value col-xs-8 col-sm-9">
            <%------  String Attribute  --------%>
                ...
                <div ng-if="attribute.attributeDef.dataType == 'TEXT'">
                    <a href="#"
                       editable-text="attribute.value.stringValue" ng-if="hasPermission('permission.machines.edit')"
                       onaftersave="machineAttributeVm.saveMachineAttribute(attribute)">
                ...
                <div id="intClick"
                    ...
                    <a href="#" ng-if="hasPermission('permission.machines.edit')"
                       editable-number="attribute.value.integerValue" e-step="any"
                       onbeforesave="machineAttributeVm.validateAttribute($data)"
                       onaftersave="machineAttributeVm.saveMachineAttribute(attribute)">
                ...
                <div ng-if="attribute.attributeDef.dataType == 'DATE'">
                    <a ng-if="attribute.editMode == false && hasPermission('permission.machines.edit')"
                       href="" ng-click="machineAttributeVm.changeAttribute(attribute)"
                       title="{{changeDate}}">
                        {{ (attribute.value.dateValue | date:"dd/MM/yyyy") || 'Click to set value'}}
                    </a>

                    <p ng-if="hasPermission('permission.machines.edit') == false">{{ (attribute.value.dateValue |
                        date:"dd/MM/yyyy")}}</p>
                    ...
                    <div ng-if="attribute.editMode == true" style="margin-left: 3px;margin-top: -41px;">
                        <button class="btn btn-md btn-primary" type="button"
                                ...
                                ng-click="machineAttributeVm.saveMachineAttribute(attribute)"><i
                                class="fa fa-check"></i>
                        </button>

                        <button class="btn btn-md btn-default" type="button"
                                style="padding: 8px 12px;"
                                ng-click="machineAttributeVm.cancelChanges(attribute)"><i class="fa fa-times"></i>
                        </button>
                </div>
                </div>
                ...
                <div ng-if="attribute.attributeDef.dataType == 'BOOLEAN' && attribute.value.booleanValue == null && hasPermission('permission.machines.edit')">
                    <a href="" editable-radiolist="attribute.value.booleanValue"
                       e-ng-options="s.value as s.name for s in machineAttributeVm.flags track by s.value"
                       onaftersave="machineAttributeVm.saveMachineAttribute(attribute)"
                ...
                <div ng-if="attribute.attributeDef.dataType == 'BOOLEAN' && attribute.value.booleanValue != null">
                    ...
                    <p ng-if="hasPermission('permission.machines.edit') == false">{{attribute.value.booleanValue}}</p>
                </div>
                ...
                <div ng-if="attribute.attributeDef.dataType == 'LIST'">
                    <a title="Click to change listValue" editable-select="attribute.value.listValue"
                       href="" e-style="width:200px;" ng-if="hasPermission('permission.machines.edit')"
                    ...
                    <p ng-if="hasPermission('permission.machines.edit') == false">{{attribute.value.listValue}}</p>
                </div>

                <%------ Time Attribute  --------%>
                <div ng-if="attribute.attributeDef.dataType == 'TIME'">
                    <a ng-if="attribute.showTimeAttribute == false && hasPermission('permission.machines.edit')"
                       href="" title="Click to change time"
                       ng-click="machineAttributeVm.changeTime(attribute)">
                        {{attribute.value.timeValue || 'Click to set value'}}
                    </a>

                    <p ng-if="hasPermission('permission.machines.edit') == false">{{attribute.value.timeValue}}</p>
                    ...
                    <div ng-if="attribute.showTimeAttribute == true">
                        ...
                        <button class="btn btn-md btn-primary" type="button"
                                ...
                                ng-click="machineAttributeVm.saveTime(attribute)"><i
                                class="fa fa-check"></i>
                        </button>

                        <button class="btn btn-md btn-default" type="button"
                                style="margin-top:-150px;padding: 8px 12px;"
                                ng-click="machineAttributeVm.cancelTime(attribute)"><i class="fa fa-times"></i>
                        </button>
                </div>
                </div>
                ...
                <div ng-if="attribute.attributeDef.dataType == 'TIMESTAMP'">
                    ...
                    <a ng-if="attribute.showTimestamp == false && hasPermission('permission.machines.edit')"
                       href="" title="Click to change timeStamp"
                       ng-click="machineAttributeVm.changeTimestamp(attribute)">
                        {{attribute.value.timestampValue || 'Click to set value'}}
                    </a>

                    <p ng-if="hasPermission('permission.machines.edit') == false">{{attribute.value.timestampValue}}</p>
                ...
                <div class="row" ng-if="attribute.attributeDef.dataType == 'OBJECT'">
                    ...
                    <a ng-if="attribute.value.refValue.objectType == 'MATERIALTYPE'" href=""
                       ng-click="machineAttributeVm.showRefValueDetails(attribute)"
                    ...
                    <a href=""
                       ng-if="attribute.value.refValue == null && attribute.editMode == false && hasPermission('permission.machines.edit')"
                       title="Add attribute"
                       ng-click="showObjectValues(attribute)">
                        Add attribute
                    </a>
                    <button ng-if="attribute.value.refValue != null && attribute.editMode == false && hasPermission('permission.machines.edit')"
                    ...
                    <button ng-if="attribute.editMode == true" class="btn btn-xs btn-primary"
                            ...
                            ng-click="machineAttributeVm.saveObject(attribute)">
                        <i class="fa fa-check"></i>
                    </button>

                    <button ng-if="attribute.editMode == true" class="btn btn-xs btn-default"
                            title="Cancel changes"
                            ng-click="machineAttributeVm.cancelChanges(attribute)">
                ...
                <div ng-if="attribute.attributeDef.dataType == 'IMAGE'">
                    <a href="" ng-click="machineAttributeVm.showImage(attribute)"
                    ...
                    <div class="inline">
                        <a href=""
                           ng-if="attribute.value.imageValue == null && hasPermission('permission.machines.edit')"
                           ng-click="machineAttributeVm.change(attribute)"
                           ng-hide="attribute.changeImage == true" title="Add image">
                            Add Image
                    </a>
                        <button ng-if="attribute.value.imageValue != null && hasPermission('permission.machines.edit')"
                            class="btn btn-xs btn-warning"
                                ng-click="machineAttributeVm.change(attribute)"
                        ...
                        <input ng-show="attribute.changeImage == true && hasPermission('permission.machines.edit')"
                               class="browse-control" name="file"
                               accept="image/*"
                               type="file" id="image" ng-file-model="attribute.newImageValue" style="width: 250px;"
                               ng-if="machineAttributeVm.clearBrowse">
                        <button class="btn btn-xs btn-primary"
                                ng-click="machineAttributeVm.saveImage(attribute)"
                                ng-show="attribute.changeImage == true && machineAttributeVm.clearBrowse"
                                title="Save image"
                                style="margin-top:-62px;margin-left: 255px;padding-top:8px;"><i
                                class="fa fa-check"></i>
                    </button>
                        <button class="btn btn-xs btn-default"
                                ng-click="machineAttributeVm.cancel(attribute)" title="Cancel changes"
                                ng-show="attribute.changeImage == true && machineAttributeVm.clearBrowse"
                ...
                <div ng-if="attribute.attributeDef.dataType == 'CURRENCY'">
                    <div ng-if="attribute.value.encodedCurrencyType != null">
                        ...
                        <span ng-if="hasPermission('permission.machines.edit') == false">{{attribute.value.currencyValue}}</span>
                    </div>
                    ...
                    <div ng-if="attribute.value.encodedCurrencyType == null || attribute.value.currencyType == null">
                        <div ng-if="attribute.changeCurrency == true" style="width: 100px;">
                            <select class="form-control" ng-model="attribute.value.currencyType"
                                    ng-init="attribute.value.currencyType = machineAttributeVm.currencies[0].id"
                                    ng-options="currency.id as currency.name for currency in machineAttributeVm.currencies">
                            </select>
                    </div>
                        <a href=""
                           ng-if="attribute.changeCurrency == false && hasPermission('permission.machines.edit')"
                           ng-click="machineAttributeVm.changeCurrencyValue(attribute)"
                           title="Change currency value">
                            {{attribute.value.currencyValue || 'Click to set value'}}
                        </a>
                        <span ng-if="hasPermission('permission.machines.edit') == false">{{attribute.value.currencyValue}}</span>
                        ...
                        <button ng-if="attribute.changeCurrency == true" class="btn btn-sm btn-primary"
                                ...
                                ng-click="machineAttributeVm.saveMachineAttribute(attribute)"
                ...
                <div ng-if="attribute.attributeDef.dataType == 'ATTACHMENT'">
                    <div ng-if="attribute.value.attachmentValues.length > 0"
                        ...
                        <ul style="margin-left:-30px;">
                            <li>
                                <a href="" ng-click="machineAttributeVm.openAttachment(attachment)"
                                   ng-if="hasPermission('permission.machines.edit') == true"
                                   title="Click to download attachment"
                                   style="margin-bottom: 5px;width:250px;color: #002451;">
                                    {{attachment.name}}
                                </a>

                                <p ng-if="hasPermission('permission.machines.edit') == false">{{attachment.name}}</p>
                                <a href="" title="Delete attachment"
                                   ng-if="hasPermission('permission.machines.edit') == true"
                                   ng-click="machineAttributeVm.deleteAttachments(attribute,attachment)">
                                    <i class="fa fa-times"
                    ...
                    <div>
                        <a href="">
                        <span ng-show="attribute.showAttachment == false && hasPermission('permission.machines.edit') == true"
                              ng-click="machineAttributeVm.addAttachment(attribute)">Add attachments
                        </span>
                        </a>
                        ...
                        <div ng-show="attribute.showAttachment == true">
                            <input class="browse-control" name="file" id="file" multiple="true"
                                   ...
                                   style="width: 250px;"/>
                            <button class="btn btn-xs btn-primary"
                                    ng-click="machineAttributeVm.saveAttachments(attribute)"
                                    title="Save attachments"
                                    style="margin-top:-62px;margin-left: 255px;padding-top:8px;">
                            <i class="fa fa-check"></i>
                        </button>
                            <button class="btn btn-xs btn-default"
                                    ng-click="machineAttributeVm.cancelAttachment(attribute)"
                                title="Cancel changes"
