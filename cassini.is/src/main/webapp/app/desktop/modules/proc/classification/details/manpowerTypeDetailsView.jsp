...
<div ng-if="manpowerTypeVm.manpowerType == null || manpowerTypeVm.manpowerType == undefined" style="padding: 10px">
    <span>No Manpower Type selected to see/edit details</span>
</div>
<div ng-if="manpowerTypeVm.manpowerType != null" <%--style="overflow-y: auto;overflow-x: hidden;"--%>>
    <div class="typeInfo">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7" ng-if="hasPermission('permission.masterdata.editClassification')==false"
                             style="margin-top: 3px;padding-top: 7px;">{{manpowerTypeVm.manpowerType.name}}
                        </div>
                        <div class="col-sm-7" ng-if="hasPermission('permission.masterdata.editClassification')==true">
                            <input type="text" class="form-control" name="title"
                                   ng-model="manpowerTypeVm.manpowerType.name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7" ng-if="hasPermission('permission.masterdata.editClassification')==false"
                             style="margin-top: 3px;padding-top: 7px;">{{manpowerTypeVm.manpowerType.description}}
                        </div>
                        <div class="col-sm-7" ng-if="hasPermission('permission.masterdata.editClassification')==true">
                        <textarea name="description" rows="5" class="form-control" style="resize: none"
                                  ng-model="manpowerTypeVm.manpowerType.description"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <ui-select ng-model="manpowerTypeVm.manpowerType.manpowerNumberSource" theme="bootstrap"
                                       ng-disabled="hasPermission('permission.masterdata.editClassification')==false"
                                       style="width:100%">
                                <ui-select-match placeholder="Select">{{$select.selected.name}}</ui-select-match>
                                <ui-select-choices
                                        repeat="source in manpowerTypeVm.autoNumbers | filter: $select.search">
        ...
        <br>
        <h4 class="section-title" ng-show="manpowerTypeVm.attributesShow">Attributes</h4>
        <br>

        <div class="row" ng-show="manpowerTypeVm.attributesShow">
            <div style="margin-left: 10px;">
                <div>
                    <button class="btn btn-xs btn-primary" ng-click="manpowerTypeVm.addAttribute()">New Attribute
                    </button>
                    <span style="margin-left: 249px; color: red;">{{manpowerTypeVm.error}}</span>
                </div>
                <div class="responsive-table">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <tr ng-if="manpowerTypeVm.manpowerType.attributes.length == 0">
                            <td colspan="7">No attributes are available to view</td>
                        </tr>
                        <tr ng-repeat="attribute in manpowerTypeVm.manpowerType.attributes">
                            ...
                            <td class="text-center">
                                    ...
                                    <ul uib-dropdown-menu class="dropdown-menu dropdown-menu-right" role="menu"
                                        ...
                                        <li ng-click="manpowerTypeVm.applyChanges(attribute)">
                                            <a class="dropdown-item" title="Save"
                                               ng-if="attribute.editMode == true">
                                                <span style="padding-left: 3px;">Save</span>
                                            </a></li>
                                        <li ng-click="manpowerTypeVm.cancelChanges(attribute)">
                                        ...
                                        <li ng-click="manpowerTypeVm.editAttribute(attribute)"
                                        ...
                                        <li ng-click="manpowerTypeVm.deleteAttribute(attribute)"
                                            ng-if="attribute.showValues == true">
                                            <a title="Delete"
                                               type="button"
                                               class="dropdown-item">
