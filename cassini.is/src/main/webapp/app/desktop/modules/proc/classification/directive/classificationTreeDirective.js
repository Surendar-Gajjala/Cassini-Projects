define(
    ...
    function (module) {
        module.directive('classificationTree', ['$compile', '$timeout', 'ClassificationService', function ($compile, $timeout, ClassificationService) {
            return {
                templateUrl: 'app/desktop/modules/proc/classification/directive/classificationTreeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '='
                ...
                link: function ($scope, elm, attr) {
                    ...
                    function loadClassificationTree() {
                        ClassificationService.getClassificationTree().then(
                            function (data) {
                                var nodes = [];
