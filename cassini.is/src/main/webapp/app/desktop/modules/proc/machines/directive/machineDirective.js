define(
    ...
    function (module) {
        module.directive('machineTree', ['$compile', '$timeout', 'ClassificationService', function ($compile, $timeout, ClassificationService) {
            return {
                templateUrl: 'app/desktop/modules/proc/machines/directive/machineDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '='
                ...
                link: function ($scope, elm, attr) {
                    ...
                    function initMachineTree() {
                        classificationTree = $('#machineTree').tree({
                            data: [
                                {
                                    id: nodeId,
                                    text: 'Machine',
