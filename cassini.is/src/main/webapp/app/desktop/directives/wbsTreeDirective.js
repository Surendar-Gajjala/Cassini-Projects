define(
    ...
    function (module) {
        module.directive('wbsTree', ['$compile', '$timeout', '$stateParams', 'WbsService', function ($compile, $timeout, $stateParams, WbsService) {
            return {
                templateUrl: 'app/desktop/directives/wbsTreeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectWbs': '='
