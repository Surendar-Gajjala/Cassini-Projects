 ...
 */
@Entity
@Table(name = "IS_FOLDER")
@PrimaryKeyJoinColumn(name = "FOLDER_ID")
@ApiObject(name = "DM")
public abstract class ISFolder extends CassiniObject {
    ...
    @Transient
    private List<ISFolder> children = new ArrayList<>();
    ...
    public List<ISFolder> getChildren() {
        return children;
    }

    public void setChildren(List<ISFolder> children) {
