...
@Entity
@Table(name = "IS_MANPOWERITEMATTRIBUTE")
...
public class ISManpowerItemAttribute extends ObjectAttribute {

    public ISManpowerItemAttribute() {
    }

    /**
     * The Method is for ISMaterialItemAttribute
     */
    public ISManpowerItemAttribute copy() {
        ISManpowerItemAttribute copy = new ISManpowerItemAttribute();
