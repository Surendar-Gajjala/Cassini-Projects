...
<%
    String bootstrap = "app/phone/phone.bootstrap.js?bust=" + new Date().getTime();
%>

<body>
<div id="appview" class="appview" layout="row" ui-view style="display: none; overflow: hidden"></div>

<script type="text/javascript" src="app/assets/bower_components/requirejs/require.js" data-main="<%=bootstrap%>"></script>
</body>
