    ...
    <div class="panel-body">
        <div class="widget-panel">
            <div class="pull-right text-center">
                ...
                <div class="btn-group" style="margin-top: 3px;">
                    <button class="btn btn-xs btn-default"
                            ...
                            ng-disabled="TasksWidgetVm.totalTasks.first">
                        Previous
                    </button>
                    <button class="btn btn-xs btn-default"
                            ng-click="TasksWidgetVm.nextPage()"
                            ng-disabled="TasksWidgetVm.totalTasks.last">
                        Next
                    </button>
                </div>
                <br>
                    <span ng-if="TasksWidgetVm.loading == false"><small>{{TasksWidgetVm.totalTasks.totalElements}} Tasks
                    </small></span>
            </div>
            <table class="table table-striped">
                ...
                <tr ng-if="TasksWidgetVm.loading == true && TasksWidgetVm.totalTasks.content.length == 0">
                    <td colspan="6">No Tasks</td>

                </tr>
                <tr ng-repeat="task in TasksWidgetVm.totalTasks.content">
