...
import com.cassinisys.tm.model.QTMAccommodation;
...
@Component
public class AccommodationPredicateBuilder implements PredicateBuilder<AccommodationCriteria, QTMAccommodation> {

    @Override
    public Predicate build(AccommodationCriteria criteria, QTMAccommodation pathBase) {
    ...
    private Predicate getFreeTextSearchPredicate(AccommodationCriteria criteria, QTMAccommodation pathBase) {
        List<Predicate> predicates = new ArrayList<>();
    ...
    private Predicate getDefaultPredicate(AccommodationCriteria criteria, QTMAccommodation pathBase) {
        List<Predicate> predicates = new ArrayList<>();
