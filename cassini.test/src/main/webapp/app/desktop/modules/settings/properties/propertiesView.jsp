<div>
    ...
    <div>
        <div class="text-right type-selector">
            <div class="dropdown dropdown-append-to-body">
                <div type="button" id="dropdownMenuButton"
                    ...
                    <span ng-if="propsVm.selectedType == null" translate>SELECT_OBJECT_TYPE</span>
                    <span class="caret"></span>
                </div>
                <ul id="dropdownMenu" class="dropdown-menu custom-dropdown" aria-labelledby="dropdownMenuButton"
                    style="height: 380px !important;overflow-y: auto">
                    <li ng-repeat="oType in propsVm.objectTypes1">
        ...
        <div ng-if="propsVm.selectedType == null" style="text-align: center;">
            <h3 style="color: lightgrey" translate>SELECT_OBJECT_TYPE</h3>
        </div>
            ...
            <div id="property{{$index}}" class="flex-col prop-container" ng-repeat="prop in propsVm.properties">
                ...
                <div class="prop-header">
                    <h5 ng-if="!prop.editMode" ng-dblclick="prop.editMode = true;
                        $('#nameInput{{$index}}').setSelectionRange(0, this.value.length)">{{prop.ppName
                        | limitTo: 30 }}{{prop.ppName.length > 30 ? '...' : ''}}</h5>
                    ...
                    <div ng-if="prop.editMode" style="display: flex">
                        ...
                        <div class="buttons" style="display: inline-block; margin-left: 4px;">
                            <i title="{{saveAttributeTitle}}" class="fa fa-check mr10"
                               ng-click="propsVm.applyChanges(prop)"></i>
                            <i title="{{'CANCEL_CHANGES' | translate}}" class="fa fa-times"
                               ng-click="propsVm.cancelChanges(prop);prop.editMode = false;"></i>
                        </div>
                    </div>
                    <div class="buttons" ng-if="!prop.editMode">
                        <i title="Edit Attribute" class="fa fa-edit mr10"
                        <%-- ng-if="hasPermission('permission.settings.edit')"--%>
                           ng-click="propsVm.editProperty(prop)"></i>
                        <i title="{{deleteAttributeTitle}}" class="fa fa-times"
                ...
                <div class="prop-body" id="prop-body{{$index}}">
                    <div style="height: 100px;">
                        <span class="text-small text-muted" translate>DESCRIPTION</span> :
                    ...
                    <div class="dropdown dropdown-append-to-body form-row">
                        <span class="text-small text-muted" translate>DATA_TYPE</span> :
                        <span type="button" id="dropdownMenuButton{{$index}}"
                            ...
                            <span ng-if="prop.newDataType == null" translate>SELECT_DATA_TYPE</span>
                        ...
                        <ul ng-if="prop.dataTypeMode" id="dropdownMenu{{$index}}" class="dropdown-menu prop-dropdown"
                            aria-labelledby="dropdownMenuButton{{$index}}" style="height: 200px;overflow: auto;">
                        ...
                        <span ng-if="prop.newDataType == 'OBJECT'" type="button" id="dropdownMenuButton1{{$index}}"
                            ...
                            <span ng-if="prop.newRefType == null" translate>SELECT_REF_TYPE</span>
                    ...
                    <div class="form-row">
                        <span class="text-small text-muted" translate>REQUIRED</span> :
