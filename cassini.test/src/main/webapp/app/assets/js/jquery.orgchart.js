(function($) {
    ...
    function OrgChart($container, opts){
        ...
        this.draw = function(){
            ...
            if(opts.allowEdit){
                $container.find('.node h2').dblclick(function(e){
        ...
        this.startEdit = function(id){
            ...
            var commitChange = function(){
                ...
                if(opts.allowEdit){
                    h2Element.dblclick(function(){
                        self.startEdit(id);
                    })
                }
                inputElement.replaceWith(h2Element);

                if(self.opts.onCommitChange !== null){
                    self.opts.onCommitChange(nodes[id]);
                }
            ...
            if(self.opts.onStartEdit !== null){
                self.opts.onStartEdit(nodes[id]);
            }
        ...
        this.newNode = function(parentId){
            ...
            return self.addNode({id: nextId, name: '', parent: parentId});
        }
    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            if(opts.showControls){
                var buttonsHtml = "<div class='org-add-button'><i class='fa fa-plus-circle'></i></div><div class='org-del-button'><i class='fa fa-minus-circle'></i></div>";
            }
            else{
                buttonsHtml = '';
            }
