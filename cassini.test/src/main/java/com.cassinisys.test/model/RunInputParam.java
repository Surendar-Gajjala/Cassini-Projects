 ...
 */
@Entity
@Table(name = "TEST_RUNINPUTPARAM")
@Data
public class RunInputParam implements Serializable {

    @Id
    @SequenceGenerator(name = "RUNINPUTPARAM_ID_GEN", sequenceName = "RUNINPUTPARAM_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "RUNINPUTPARAM_ID_GEN")
    ...
    private String name;
    @Transient
    private RunInputParamValue runInputParamValue;
