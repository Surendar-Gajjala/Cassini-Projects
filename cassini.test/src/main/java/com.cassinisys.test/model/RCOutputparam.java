 ...
 */
@Entity
@Table(name = "TEST_RCOUTPUTPARAM")
@JsonIgnoreProperties(ignoreUnknown = true)
@ApiObject(group = "TEST")
@Data
public class RCOutputparam implements Serializable {
    @Id
    @SequenceGenerator(name = "RCOUTPUTPARAM_ID_GEN", sequenceName = "RCOUTPUTPARAM_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "RCOUTPUTPARAM_ID_GEN")
