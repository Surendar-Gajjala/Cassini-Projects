...
hibernate.tenant_identifier_resolver=com.cassinisys.tms.config.CassiniTenantIdentifierResolver
hibernate.multi_tenant_connection_provider=com.cassinisys.tms.config.CassiniTenantConnectionProvider

# cassini properties
cassini.tenants=cassini_tms
cassini.fs.root=C:/Temp/cassinisys/cassini.tms
