define(
    ...
    function (module) {
        module.controller('CustomFileReplaceController', CustomFileReplaceController);

        function CustomFileReplaceController($scope, $rootScope, $timeout, $state, $stateParams, $cookies, $translate, CommonService) {
            var vm = this;
            ...
            var customId = $scope.data.selectedCustomId;
            ...
            function initFilesTableDropzone() {
                ...
                var dropZone = new Dropzone(document.querySelector('#changeReplaceFiles'), { // Make the whole body a dropzone
                    url: "api/customObjects/" + customId + "/files/" + vm.file.id + "/replaceFile", // Set the url
                    thumbnailWidth: 80,
                    thumbnailHeight: 80,
                    timeout: 500000,
