<div>
    ...
    <div class='responsive-table'>
        <table class='table table-striped highlight-row'>
            ...
            <tbody>
            <tr ng-if="reqReviewersVm.loading == true">
            ...
            <tr ng-if="reqReviewersVm.loading == false && reqReviewersVm.reqReviewers.length == 0">
            ...
            <tr ng-if="reqReviewersVm.reqReviewers.length > 0"
                ng-repeat="reviewer in reqReviewersVm.reqReviewers">
