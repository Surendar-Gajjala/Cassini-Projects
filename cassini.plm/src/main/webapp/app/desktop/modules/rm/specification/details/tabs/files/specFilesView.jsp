...
<div ng-show="specFilesVm.showDropzone == false" id="itemFiles"
<%-- ng-class="{disabled:selectedSpecification.lifecyclePhase.phaseType == 'RELEASED'}"--%>>
    <div class="responsive-table">
        <div id="parentFile" style="font-style: italic; text-align: center;"
             ng-if="selectedSpecification.lifecyclePhase.phaseType != 'RELEASED' && (hasPermission('pgcspecification','edit')
              || hasPermission('pgcspecification','edit') || specPermission.editPermission)" dragfile
             files="specFilesVm.files" update-file="specFilesVm.updateFile">
            {{dragAndDropFilesTitle}} <a href="" ng-click="specFilesVm.selectFile()">({{clickToAddFilesTitle}})</a>
        </div>

        <div>
            <tr id="attachmentsContainer" ng-show="specFilesVm.showFileDropzone == true"
        ...
        <table id="itemFilesTable" class="table table-striped highlight-row">
            ...
            <tr>
                <th>
                    <span uib-dropdown dropdown-append-to-body style="width: 100%;"
                        ...
                        <ul uib-dropdown-menu class="dropdown-menu" role="menu" style="z-index: 9999 !important;">
                            <li>
                                <a href="" ng-click="addSpecFolder()"
                                   translate>NEW_FOLDER</a>
                            </li>
                            <li ng-if="clipBoardSpecFiles.length > 0">
                                <a href=""
                                   ng-click="specFilesVm.pasteFilesFromClipboard(specFilesVm.specificationId,'ITEM')"
                ...
                <th translate style="text-align: center;width: 80px">ACTIONS</th>
            </tr>
            </thead>
            <tbody>
            <tr ng-if="specFilesVm.loading == true">
            ...
            <tr ng-if="specFilesVm.loading == false && specFilesVm.files.length == 0">
            ...
            <tr id="{{$index}}" ng-if="specFilesVm.files.length > 0"
                ng-repeat="file in specFilesVm.files" dragfile files="specFilesVm.files"
                update-file="specFilesVm.updateFile">
                <td style="text-align: center;display: flex;">
                    <div ng-show="file.fileType == 'FILE'" class="ckbox ckbox-default"
                        ...
                        <input id="file{{$index}}" name="fileSelected" type="checkbox" ng-value="true"
                               ng-model="file.selected" ng-change="specFilesVm.selectClipboardFile(file)">
                  ...
                  <span style="text-align: center;width: 100%;" ng-show="file.fileType != 'FOLDER'"
                        ng-click="specFilesVm.filePreview(file)" title="{{specFilesVm.previewFile}}">
                  ...
                  <span ng-show="file.fileType == 'FOLDER'" uib-dropdown dropdown-append-to-body
                        ...
                        <i class="la la-plus dropdown-toggle" uib-dropdown-toggle
                           title="{{specFilesVm.title}}" ng-click="specFilesVm.loadFolderFile(file)"
                           style="padding-left: 3px;"></i>
                        <ul uib-dropdown-menu class="dropdown-menu" role="menu" style="z-index: 9999 !important;">
                            <li>
                                <a href="" ng-click="specFilesVm.addFolder(file)"
                            ...
                            <li ng-if="clipBoardSpecFiles.length > 0">
                                <a href="" ng-click="specFilesVm.pasteFilesFromClipboard(file,'FOLDER')"
                                   translate>PASTE_FROM_CLIPBOARD</a>
                            </li>
                        </ul>
                  </span>
                ...
                <td>
                    <span class="level{{file.level}}" ng-show="file.fileType == 'FOLDER'">
                        <i class="mr5 fa" title="{{specFilesVm.ExpandCollapse}}"
                           ...
                           ng-click="specFilesVm.toggleNode(file)">
                            <%--<span class="folder-count">{{file.count}}</span>--%>
                        </i>
                            <span ng-click="specFilesVm.toggleNode(file)"
                                  class="autoClick"
                    ...
                    <span class="level{{file.level}}" ng-show="file.fileType == 'FILE'">
                        <a href="" ng-click="specFilesVm.downloadFile(file)"
                ...
                <td style="text-align: center">
                    <input type="checkbox" ng-model="file.locked"
                           ng-disabled="selectedSpecification.lifecyclePhase.phaseType == 'RELEASED' || (file.locked && file.lockedBy != loginPersonDetails.person.id)"
                           ng-change="specFilesVm.lockFile(file, file.locked)">
                </td>
                    ...
                    <span class="row-menu" uib-dropdown style="min-width: 50px">
                        ...
                        <i class="fa fa-ellipsis-h dropdown-toggle" uib-dropdown-toggle></i>
                            <ul uib-dropdown-menu class="dropdown-menu dropdown-menu-right" role="menu"
                                ...
                                <li ng-click="specFilesVm.showFileEdit(file)"
                                ...
                                <li ng-click="specFilesVm.fileReplace(file)"
                                    ng-if="(hasPermission('pgcspecification','edit') || specPermission.editPermission) && selectedSpecification.lifecyclePhase.phaseType != 'RELEASED' && file.fileType == 'FILE'"
                                    ng-hide="file.locked">
                                    <a href="" style="color: #333 !important;" translate>FILE_REPLACE_TITLE</a>
                                </li>
                                <li ng-click="specFilesVm.showFileHistory(file)" ng-if="file.fileType == 'FILE'">
                                    <a href="" style="color: #333 !important;" translate>FILE_HISTORY_TITLE</a>
                                </li>
                                <li ng-click="specFilesVm.showFileDownloadHistory(file)"
                                    ng-if="file.fileType == 'FILE'">
                                    <a href="" style="color: #333 !important;" translate>FILE_DOWNLOAD_HISTORY_TITLE</a>
                                </li>
                                <li ng-click="specFilesVm.renameFile(file)"
                                    ng-hide="file.locked"
                                    ng-if="selectedSpecification.lifecyclePhase.phaseType != 'RELEASED' && file.fileType == 'FILE'">
                                ...
                                <li ng-hide="file.locked"
                                    ...
                                    ng-click="specFilesVm.deleteFile(file)">
                                ...
                                <li ng-hide="file.locked"
                                    ...
                                    ng-click="specFilesVm.deleteFolder(file)">
