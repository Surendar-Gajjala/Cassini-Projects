define(
    ...
    function (module) {
        ...
        function PersonsSelectionController($scope, $rootScope, $stateParams, $timeout, $translate, CommonService, SpecificationsService) {
            var vm = this;
            ...
            function loadPersons() {
                SpecificationsService.getAllPersons($stateParams.specId).then(
                    function (data) {
                        vm.logins = data;
            ...
            function onOk() {
                if (vm.selectPersons.length == 0) {
                    ...
                    SpecificationsService.createSpecPersons($stateParams.specId, vm.selectPersons).then(
                        function (data) {
