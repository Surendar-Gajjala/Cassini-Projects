                ...
                <div class="direction-r">
                    <div class="flag-wrapper" style="text-align: left !important;">
                            <span class="flag" style=""
                                  ng-click="requirementRevisionHistoryVm.showVersionDetails(version)">
                    ...
                    <span class="time">
                        <span>{{version.createdDate}}</span><span style="font-style: italic;">( {{version.createdByObject.fullName}} )</span>
                    </span>
                </span>
                    </div>
