<div style="padding: 10px">
    ...
    <div ng-if='fileHistoryVm.fileMode == "SpecificationFileVersion"'>
        <h4>{{fileHistoryVm.fileName}}</h4>

        <p class="text-muted" style="font-style: italic">({{clickOnVersionDownload}})</p>
        ...
        <div class="comments-panel">
            <ul class="timeline">
                <li ng-repeat="fileVersion in fileHistoryVm.fileVersions">
                    <div class="direction-r">
                        ...
                        <span class="time-wrapper">
                            ...
                            <i class="fa" ng-click="fileHistoryVm.showComment(fileVersion)"
                               ...
                               title="{{(fileVersion.showComments ? 'HIDE_COMMENTS' : 'SHOW_COMMENT') | translate}}"
                    ...
                    <h6 ng-if="fileVersion.comments.length == null" style="width: 300px;margin: 0px;">
                        {{fileVersionHasNoComments}}</h6>
                </li>
            </ul>
        </div>
        <div class="comment-input" ng-if="selectedSpecification.lifecyclePhase.phaseType != 'RELEASED'"
