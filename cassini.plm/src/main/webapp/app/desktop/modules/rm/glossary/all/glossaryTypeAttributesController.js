define([
    ...
    function (module) {
        module.controller('GlossaryTypeAttributesController', GlossaryTypeAttributesController);

        function GlossaryTypeAttributesController($scope, $rootScope, $timeout, $state, $stateParams, $translate, $cookies, GlossaryService) {
            ...
            function loadCustomItemAttributes() {
                GlossaryService.getAllTypeAttributes("TERMINOLOGY").then(
                    function (data) {
