define([
    ...
    function (module) {
        module.controller('ActivityTypeAttributesController', ActivityTypeAttributesController);

        function ActivityTypeAttributesController($scope, $rootScope, $translate, $timeout, $state, $stateParams, $cookies, ProjectService) {

            var vm = this;
            var parsed = angular.element("<div></div>");
            var selectAtleastAttributesMessage = parsed.html($translate.instant("SELECT_ATLEAST_ATTRIBUTE_MESSAGE")).html();
            ...
            function onOk() {
                ...
                else $rootScope.showWarningMessage(selectAtleastAttributesMessage);
            }

            function loadCustomItemAttributes() {
                ProjectService.getAllTypeAttributes("PROJECTACTIVITY").then(
                    function (data) {
