...
define(['app/desktop/modules/pm/pm.module',
    ...
    function (module) {
        ...
        function PersonDialogueController($scope, $rootScope, $timeout, $translate, $state, LoginService, ProgramTemplateService, $stateParams, CommonService, ItemService) {
            ...
            function onOk() {
                if (vm.selectedPersons.length == 0) {
                    ...
                    $scope.$off('app.programtemplate.resource.new', onOk);
                }
            }
            ...
            (function () {
                ...
                loadPersons();
                $scope.$on('app.programtemplate.resource.new', onOk);
                //}
            })();
        }
