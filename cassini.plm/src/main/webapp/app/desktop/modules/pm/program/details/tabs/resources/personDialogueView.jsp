    ...
    <table class="table table-striped highlight-row">
        ...
        <tr>
            <th style="width: 80px; text-align: center">
                <input ng-if="personDialogueVm.persons.length != 0" name="item" type="checkbox"
        ...
        <tr ng-if="personDialogueVm.persons.length == 0">
            <td colspan="12" translate>NO_PERSONS</td>
        </tr>

        <tr ng-repeat="person in personDialogueVm.persons">
            <td style="width: 80px; text-align: center">
                <input type="checkbox" name="person" value="person" ng-click="personDialogueVm.select(person)"
