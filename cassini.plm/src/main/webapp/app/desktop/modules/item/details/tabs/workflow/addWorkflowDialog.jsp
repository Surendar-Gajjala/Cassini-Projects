                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <ui-select ng-model="addWorkflowVm.addWf.workflowDefinition"
                                   ...
                                   title="{{addWorkflowVm.addWf.workflowDefinition.name}} [ Revision : {{addWorkflowVm.addWf.workflowDefinition.revision}} ]"
                                   style="width:100%">
                            <ui-select-match placeholder={{addWorkflowVm.selectWorkflow}}>{{$select.selected.name}}
                                [ Revision : {{$select.selected.revision}} ]
                            </ui-select-match>
                            <ui-select-choices repeat="workflow in addWorkflowVm.wfs | filter: $select.search">
