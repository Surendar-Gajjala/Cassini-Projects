...
<div class="view-container" fitcontent>
    <div class="view-toolbar">
        <span style="font-weight: 600;font-size: 20px;padding-right: 10px;" translate>TEMPLATE</span>

        <button class="btn btn-sm new-button" ng-click="allTemplatesVm.showNewTemplate()" id="newTemplate"
                title="{{allTemplatesVm.newTemplateTitle}}" ng-if="hasPermission('template','create')">
            <i class="las la-plus" aria-hidden="true"></i>
            <span>{{'NEW_TEMPLATE' | translate}}</span>
        </button>

        <free-text-search on-clear="allTemplatesVm.resetPage" search-term="allTemplatesVm.searchText"
                          on-search="allTemplatesVm.freeTextSearch"
                          filter-search="allTemplatesVm.filterSearch"></free-text-search>
    ...
    <div class="view-content no-padding" style="overflow-y: auto;padding: 10px;">
        <div class="responsive-table" style="padding: 10px;">
            <table class="table table-striped highlight-row">
                ...
                <tbody>
                <tr ng-if="allTemplatesVm.loading == true">
                    <td colspan="25">
                ...
                <tr ng-if="allTemplatesVm.loading == false && allTemplatesVm.projectTemplates.content.length == 0">
                ...
                <tr ng-repeat="template in allTemplatesVm.projectTemplates.content">
                    <td id="name" class="col-width-200">
                        <a ng-click="allTemplatesVm.showTemplate(template)"
                           title="{{allTemplatesVm.openTemplateTitle}}">
                        ...
                        <i class="fa fa-ellipsis-h dropdown-toggle" uib-dropdown-toggle></i>
                            <ul uib-dropdown-menu class="dropdown-menu dropdown-menu-right" role="menu"
                                ...
                                <li ng-if="hasPermission('template','delete')"
                                    ...
                                    ng-click="allTemplatesVm.deleteTemplate(template)"><a translate>DELETE_TEMPLATE</a>
                                </li>
        ...
        <div class="table-footer">
            <table-footer objects="allTemplatesVm.projectTemplates" pageable="allTemplatesVm.pageable"
                          previous-page="allTemplatesVm.previousPage"
                          next-page="allTemplatesVm.nextPage" page-size="allTemplatesVm.pageSize"></table-footer>
        </div>
    </div>
</div>
