define(
    ...
    function (module) {
        module.controller('MBOMInstanceOperationInstructionsController', MBOMInstanceOperationInstructionsController);

        function MBOMInstanceOperationInstructionsController($scope, $rootScope, $timeout, $sce, $state, $translate, $stateParams, MBOMInstanceService, $cookies, $uibModal, httpFactory) {
            ...
            function loadInstructions() {
                MBOMInstanceService.getMbomInstanceOperationInstructions(vm.operationId).then(
                    function (data) {
