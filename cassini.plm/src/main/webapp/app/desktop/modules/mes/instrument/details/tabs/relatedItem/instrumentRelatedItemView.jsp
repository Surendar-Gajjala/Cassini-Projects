<div>
  ...
  <div class="form-group" style="margin: 0;padding-top: 10px;text-align: center;"
       ng-if="instrumentRelatedItemVm.bomItems.length > 0">
    <div class="ckbox ckbox-default" style="display: inline-block;">
      <input id="revisions" type="checkbox" ng-model="instrumentRelatedItemVm.showAllRevisions"
             style="width: 25px;box-shadow: none;margin-top: 2px;"
             ng-change="instrumentRelatedItemVm.loadAllRevisions(instrumentRelatedItemVm.showAllRevisions)">
  ...
  <div class='responsive-table' id="whereUsedTable" style="top: 42px;">
    <table class='table table-striped highlight-row'>
      ...
      <tbody>
      <tr ng-if="instrumentRelatedItemVm.loading == true">
        <td colspan="9">
      ...
      <tr ng-if="instrumentRelatedItemVm.loading == false && instrumentRelatedItemVm.bomItems.length == 0">
