                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <div style="overflow: auto;padding: 5px; border: 1px solid #FFF;width: 300px;height: 200px;">
                                            <manufacturing-type-tree
                                                    on-select-type="newInstrumentVm.onSelectType"
                                                    object-type="INSTRUMENTTYPE"></manufacturing-type-tree>
                                        </div>
                                    </div>
                                </div>
                                <input type="text" class="form-control" name="title"
                                       ng-model="newInstrumentVm.selectedInstrumentType.name" readonly>
                            ...
                            <div class="input-group mb15">
                                <div class="input-group-btn">
                                    <button class="btn btn-default" type="button" style="width: 85px"
                                            ng-click="newInstrumentVm.autoNumber()" translate>AUTO
                                    </button>
                                </div>
                                <input type="text" class="form-control" name="title"
                                       ng-model="newInstrumentVm.newInstrument.number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" placeholder="{{'ENTER_NAME' | translate}}"
                                   name="title" ng-model="newInstrumentVm.newInstrument.name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-7">
                            <textarea class="form-control" rows="3" style="resize: none"
                                      ...
                                      ng-model="newInstrumentVm.newInstrument.description"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-7">
                            <input id="imageId" type="file" class="form-control" accept="image/*"
                                   ng-file-model="newInstrumentVm.newInstrument.imageFile">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="checkbox" id="requiresMaintenance" switch="none" checked=""
                                   ng-model="newInstrumentVm.newInstrument.requiresMaintenance">
                            <label for="requiresMaintenance" data-on-label="Yes" data-off-label="No"></label>
                        </div>
                    </div>
                    <div ng-show="newInstrumentVm.newInstrument.requiresMaintenance">
                        <mes-asset asset="newInstrumentVm.newAsset"></mes-asset>
                    </div>
                    <mes-mfr-data update-type="'creation'" has-permission="true"
                                  manufacturer-data="newInstrumentVm.newInstrument.manufacturerData"></mes-mfr-data>
                    <attributes-view show-objects="selectObjectValues" ng-if="newInstrumentVm.attributes.length > 0"
                                     attributes="newInstrumentVm.attributes"></attributes-view>
                </form>
                <br>
            </div>
        </div>
