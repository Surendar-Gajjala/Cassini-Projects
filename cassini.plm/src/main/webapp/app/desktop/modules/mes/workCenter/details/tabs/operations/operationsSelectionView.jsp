...
<div style="padding: 0 10px;">
    ...
    <form class="form-inline" style="margin: 5px 0px">
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-btn" uib-dropdown>
                    <div class="dropdown-menu" role="menu">
                        <div style="overflow: auto;padding: 5px; border: 1px solid #FFF;height: 200px;">
                            ...
                            on-select-type="operationsSelectionVm.onSelectType"
                ...
                <input type="text" class="form-control" name="title"
                       ...
                       ng-model="operationsSelectionVm.filters.reqType.name" readonly>
        ...
        <div class="form-group">
            <input type="text" ng-model="operationsSelectionVm.filters.number" style="width: 165px;"
                   ng-change="operationsSelectionVm.searchItems()"
                   placeholder="{{'NUMBER' | translate}}"
                   class="form-control">
        </div>
        <div class="form-group">
            <input type="text" ng-model="operationsSelectionVm.filters.name"
                   ng-change="operationsSelectionVm.searchItems()"
                   style="width: 165px;"
        ...
        <div class="pull-right" style="margin-top: 5px;">
            <button class="btn btn-sm btn-danger" ng-if="operationsSelectionVm.clear == true"
                    ng-click="operationsSelectionVm.clearFilter()" translate>CLEAR
            </button>
        </div>
        ...
        <div class="col-md-12" style="border: 1px solid lightgrey;">
            <div class="col-md-4">
                <div style="padding: 10px;">
                    <span style="color:#1877f2e6">Selected Operations</span>
                    <span class="badge">{{operationsSelectionVm.selectedItems.length}}</span>
                </div>
            </div>
            <div class="col-md-8">
                <div class="pull-right text-center" style="padding: 10px;">
                    <div>
                        ...
                        <span class="mr10"> Page  {{operationsSelectionVm.operations.totalElements != 0 ? operationsSelectionVm.operations.number+1:0}} <span
                                translate> OF </span> {{operationsSelectionVm.operations.totalPages}} </span>
        ...
        <div class="col-md-12 table-div" style="padding:0px; height: auto;overflow: auto;">
            <div class="item-selection-table">
                <table class="table table-striped">
                    ...
                    <tr>
                        <th style="vertical-align: top;text-align: left">
                            <input name="itemSelected" ng-value="true" type="checkbox"
                                   ng-model="operationsSelectionVm.selectAllCheck"
                                   ng-if="operationsSelectionVm.operations.content.length != 0"
                                   ng-click="operationsSelectionVm.selectAll()">
                        </th>
                    ...
                    <tbody>
                    <tr ng-if="operationsSelectionVm.operations.content.length == 0">
                        <td colspan="15" >No Operations</td>
                    </tr>
                    <tr ng-if="operationsSelectionVm.operations.content.length > 0"
                        ng-repeat="operation in operationsSelectionVm.operations.content">
                        <th style="vertical-align: top; text-align: left">
                            <input name="item" type="checkbox" ng-model="operation.selected"
                        ...
                        <td title="{{operation.description}}" class="col-width-250">
