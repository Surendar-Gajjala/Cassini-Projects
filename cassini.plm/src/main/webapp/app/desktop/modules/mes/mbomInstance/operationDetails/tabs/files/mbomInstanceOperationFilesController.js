define(
    ...
    function (module) {
        module.controller('MBOMInstanceOperationFilesController', MBOMInstanceOperationFilesController);

        function MBOMInstanceOperationFilesController($scope, $rootScope, $timeout, $state, $stateParams, $q, $translate, $application) {
            var vm = this;
