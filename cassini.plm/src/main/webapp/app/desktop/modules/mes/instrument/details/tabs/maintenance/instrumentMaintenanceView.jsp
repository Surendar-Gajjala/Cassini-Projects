<div>
  ...
  <div class="form-group" style="margin: 0;padding-top: 10px;text-align: center;"
       ng-if="instrumentMaintenanceVm.bomItems.length > 0">
    <div class="ckbox ckbox-default" style="display: inline-block;">
      <input id="revisions" type="checkbox" ng-model="instrumentMaintenanceVm.showAllRevisions"
             style="width: 25px;box-shadow: none;margin-top: 2px;"
             ng-change="instrumentMaintenanceVm.loadAllRevisions(instrumentMaintenanceVm.showAllRevisions)">
  ...
  <div class='responsive-table' id="whereUsedTable" style="top: 42px;">
    <table class='table table-striped highlight-row'>
      ...
      <tbody>
      <tr ng-if="instrumentMaintenanceVm.loading == true">
        <td colspan="9">
      ...
      <tr ng-if="instrumentMaintenanceVm.loading == false && instrumentMaintenanceVm.bomItems.length == 0">
