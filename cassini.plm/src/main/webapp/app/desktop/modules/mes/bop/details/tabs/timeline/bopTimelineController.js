define(
    ...
    function (module) {
        module.controller('BOPTimeLineController', BOPTimeLineController);

        function BOPTimeLineController($scope, $rootScope, $timeout, $state, $stateParams, $cookies, $window, $application,
                                       $translate) {
            var vm = this;
