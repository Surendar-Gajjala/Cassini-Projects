                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <div style="overflow: auto;padding: 5px; border: 1px solid #FFF;width: 300px;height: 200px;">
                                            <manufacturing-type-tree
                                                    on-select-type="newEquipmentVm.onSelectType"
                                                    object-type="EQUIPMENTTYPE"></manufacturing-type-tree>
                                        </div>
                                    </div>
                                </div>
                                <input type="text" class="form-control" name="title"
                                       ng-model="newEquipmentVm.selectedEquipmentType.name" readonly>
                            ...
                            <div class="input-group mb15">
                                <div class="input-group-btn">
                                    <button class="btn btn-default" type="button" style="width: 85px"
                                            ng-click="newEquipmentVm.autoNumber()" translate>AUTO
                                    </button>
                                </div>
                                <input type="text" class="form-control" name="title"
                                       ng-model="newEquipmentVm.newEquipment.number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" placeholder="{{'ENTER_NAME' | translate}}"
                                   name="title" ng-model="newEquipmentVm.newEquipment.name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-7">
                            <textarea class="form-control" rows="3" style="resize: none"
                                      ...
                                      ng-model="newEquipmentVm.newEquipment.description"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-7">
                            <input id="imageId" type="file" class="form-control" accept="image/*"
                                   ng-file-model="newEquipmentVm.newEquipment.imageFile">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-7">
                            <input type="checkbox" id="requiresMaintenance" switch="none" checked=""
                                   ng-model="newEquipmentVm.newEquipment.requiresMaintenance">
                            <label for="requiresMaintenance" data-on-label="Yes" data-off-label="No"></label>
                        </div>
                    </div>
                    <div ng-show="newEquipmentVm.newEquipment.requiresMaintenance">
                        <mes-asset asset="newEquipmentVm.newAsset"></mes-asset>
                    </div>
                    <div>
                        <mes-mfr-data update-type="'creation'" has-permission="true"
                                      manufacturer-data="newEquipmentVm.newEquipment.manufacturerData"></mes-mfr-data>
                    </div>
                    <attributes-view show-objects="selectObjectValues" ng-if="newEquipmentVm.attributes.length > 0"
                                     attributes="newEquipmentVm.attributes"></attributes-view>
                </form>
            </div>
        </div>
    </div>
