<div>
  ...
  <div class="form-group" style="margin: 0;padding-top: 10px;text-align: center;"
       ng-if="machineRelatedItemVm.bomItems.length > 0">
    <div class="ckbox ckbox-default" style="display: inline-block;">
      <input id="revisions" type="checkbox" ng-model="machineRelatedItemVm.showAllRevisions"
             style="width: 25px;box-shadow: none;margin-top: 2px;"
             ng-change="machineRelatedItemVm.loadAllRevisions(machineRelatedItemVm.showAllRevisions)">
  ...
  <div class='responsive-table' id="whereUsedTable" style="top: 42px;">
    <table class='table table-striped highlight-row'>
      ...
      <tbody>
      <tr ng-if="machineRelatedItemVm.loading == true">
        <td colspan="9">
      ...
      <tr ng-if="machineRelatedItemVm.loading == false && machineRelatedItemVm.bomItems.length == 0">
