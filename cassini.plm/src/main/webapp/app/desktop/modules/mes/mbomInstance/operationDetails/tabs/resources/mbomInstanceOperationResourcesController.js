define(
    ...
    function (module) {
        module.controller('MBOMInstanceOperationResourcesController', MBOMInstanceOperationResourcesController);

        function MBOMInstanceOperationResourcesController($scope, $rootScope, $timeout, $state, $translate, $stateParams, $cookies, $uibModal,
                                            httpFactory, MBOMInstanceService, AutonumberService, DialogService) {
            ...
            function loadResources() {
                vm.loading = true;
                MBOMInstanceService.getMbomInstanceOperationResources(vm.operationId).then(
                    function (data) {
