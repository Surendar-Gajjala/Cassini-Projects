define(
    ...
    function (module) {
        module.controller('BOPPlanItemsController', BOPPlanItemsController);

        function BOPPlanItemsController($scope, $rootScope, $timeout, $state, $translate, $stateParams, $cookies, $uibModal,
                                        httpFactory, BOPService, DialogService) {
            ...
            function loadBopPlanItems() {
                vm.loading = true;
                BOPService.getBopPlanItems(vm.bopPlanId).then(
                    function (data) {
