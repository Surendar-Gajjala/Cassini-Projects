<div>
    ...
    <div class='responsive-table'>
        <table class='table table-striped highlight-row'>
            ...
            <tr>
                <th style="width: 50px;">
                    <i class="la la-plus" style="cursor: pointer"
                       ...
                       ng-click="showReqTemplateReviewers()"></i>
                </th>
            ...
            <tbody>
            <tr ng-if="reqTemplateReviewersVm.loading == true">
            ...
            <tr ng-if="reqTemplateReviewersVm.loading == false && reqTemplateReviewersVm.reqReviewers.length == 0">
            ...
            <tr ng-if="reqTemplateReviewersVm.reqReviewers.length > 0"
                ng-repeat="reviewer in reqTemplateReviewersVm.reqReviewers">
