define(
    [
        ...
        'app/desktop/modules/mro/spareParts/details/tabs/basic/sparePartBasicInfoController',
        'app/desktop/modules/mro/spareParts/details/tabs/attributes/sparePartAttributesController',
        'app/desktop/modules/mro/spareParts/details/tabs/timeline/sparePartTimelineController',
        'app/desktop/modules/mro/spareParts/details/tabs/files/sparePartFilesController',
    ...
    function (module) {
        module.controller('SparePartsDetailsController', SparePartsDetailsController);

        function SparePartsDetailsController($scope, $rootScope, $timeout, $state, $stateParams, $cookies, $window, $application,
                                             ECOService, $translate, SparePartService, CommentsService, CommonService) {
            ...
            vm.tabs = {
                basic: {
                    id: 'details.basic',
                    heading: basic,
                    template: 'app/desktop/modules/mro/spareParts/details/tabs/basic/sparePartBasicInfoView.jsp',
                    index: 0,
                    active: true,
                    activated: true
                }/*,
                 ...
                 template: 'app/desktop/modules/mro/spareParts/details/tabs/attributes/sparePartAttributesView.jsp',
                 index: 1,
                 active: true,
                 activated: true
                 }*/,
                files: {
                    ...
                    template: 'app/desktop/modules/mro/spareParts/details/tabs/files/sparePartFilesView.jsp',
                    index: 1,
                    active: false,
                    activated: false
                },
                timelineHistory: {
                    ...
                    template: 'app/desktop/modules/mro/spareParts/details/tabs/timeline/sparePartTimelineView.jsp',
                    index: 2,
                    active: false,
                    activated: false
                }
            ...
            if (tabId == null || tabId === undefined || tabId.trim() === "") {
                tabId = 'details.basic';
                $state.transitionTo('app.mro.sparePart.details', {
            ...
            function refreshDetails() {
                $scope.$broadcast('app.sparePart.tabActivated', {tabId: $rootScope.selectedTab.id});
            }
            ...
            function tabActivated(tabId) {
                $state.transitionTo('app.mro.sparePart.details', {
                    sparePartId: vm.sparePartId, tab: tabId
                }, {notify: false});
                var tab = getTabById(tabId);
                vm.active = tab.index;
                if (tab != null) {
                    ...
                    tab.active = true;
                    activateTab(tab);
                    $scope.$broadcast('app.sparePart.tabActivated', {tabId: tabId});
            ...
            function freeTextSearch(freeText) {
                ...
                if (freeText != null && freeText != undefined && freeText.trim() != "") {
                    ...
                    $rootScope.freeTextQuerys = null;
                    $scope.$broadcast('app.sparePart.tabActivated', {tabId: 'details.files'});
                }
            }
            ...
            function loadCommentsCount() {
                CommentsService.getAllCommentsCount('MROSPAREPART', vm.sparePartId).then(
                    function (data) {
                        $rootScope.showComments('MROSPAREPART', vm.sparePartId, data);
                        $rootScope.showTags('MROSPAREPART', vm.sparePartId, vm.sparePart.tags.length);
                    }, function (error) {
                        $rootScope.showErrorMessage(error.message);
                    }
                )
            ...
            (function () {
                ...
                if (lastSelectedTab != null && lastSelectedTab != undefined) {
                    ...
                    $timeout(function () {
                        $scope.$broadcast('app.sparePart.tabActivated', {tabId: lastSelectedTab});
                    }, 1000)
