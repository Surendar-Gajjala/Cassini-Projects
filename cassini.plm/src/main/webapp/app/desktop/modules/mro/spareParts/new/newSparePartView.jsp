                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <div style="overflow: auto;padding: 5px; border: 1px solid #FFF;width: 300px;height: 200px;">
                                            ...
                                            <manufacturing-type-tree
                                                    on-select-type="newSparePartVm.onSelectType"
                                                    object-type="SPAREPARTTYPE"></manufacturing-type-tree>
                                        </div>
                                    </div>
                                </div>
                                <input type="text" class="form-control" name="title"
                                       ng-model="newSparePartVm.type.name" readonly>
                            ...
                            <div class="input-group mb15">
                                <div class="input-group-btn">
                                    <button class="btn btn-default" type="button" style="width: 85px"
                                            ng-click="newSparePartVm.autoNumber()" translate>AUTO
                                    </button>
                                </div>
                                <input type="text" class="form-control" name="title"
                                       ng-model="newSparePartVm.newSparePart.number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" placeholder="{{'ENTER_NAME' | translate}}"
                                   name="title" ng-model="newSparePartVm.newSparePart.name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-7">
                            <textarea class="form-control" rows="3" style="resize: none"
                                      ...
                                      ng-model="newSparePartVm.newSparePart.description"></textarea>
                        </div>
                    </div>
                    <attributes-view show-objects="selectObjectValues" ng-if="newSparePartVm.attributes.length > 0"
                                     attributes="newSparePartVm.attributes"></attributes-view>
