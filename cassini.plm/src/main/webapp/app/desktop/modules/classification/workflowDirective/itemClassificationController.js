define(
    ...
    function (module) {
        module.controller('ItemClassificationController', ItemClassificationController);

        function ItemClassificationController($scope, $rootScope, $timeout, $state, $stateParams, $cookies,
                                              ItemTypeService) {
