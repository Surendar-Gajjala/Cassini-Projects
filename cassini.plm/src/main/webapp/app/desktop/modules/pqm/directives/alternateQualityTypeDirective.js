define(
    ...
    function (module) {
        module.directive('qualityTree', ['$compile', '$timeout', 'QualityTypeService', function ($compile, $timeout, QualityTypeService) {
            return {
                templateUrl: 'app/desktop/modules/pqm/directives/alternateQualityTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '=',
