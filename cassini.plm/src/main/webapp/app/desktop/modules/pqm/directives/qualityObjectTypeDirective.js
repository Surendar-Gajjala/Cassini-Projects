define(
    ...
    function (module) {
        module.directive('qualityObjectTypeTree', ['$compile', '$timeout', 'QualityTypeService', function ($compile, $timeout, QualityTypeService) {
            return {
                templateUrl: 'app/desktop/modules/pqm/directives/qualityObjectTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '=',
                ...
                link: function ($scope, elm, attr) {
                    ...
                    function initTree() {
                        changeTree = $('#qualityObjectTypeTree').tree({
                            data: [
                                {
                                    id: nodeId,
                                    text: 'Quality',
