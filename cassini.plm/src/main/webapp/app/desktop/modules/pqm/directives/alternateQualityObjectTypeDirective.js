define(
    ...
    function (module) {
        module.directive('qualityObjectTree', ['$compile', '$timeout', 'QualityTypeService', function ($compile, $timeout, QualityTypeService) {
            return {
                templateUrl: 'app/desktop/modules/pqm/directives/alternateQualityObjectTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '=',
                ...
                link: function ($scope, elm, attr) {
                    ...
                    function initTree() {
                        changeTree = $('#qualityObjectTree').tree({
                            data: [
                                {
                                    id: nodeId,
                                    text: 'Quality',
