<div>
    <div class='responsive-table'>
        <table class='table table-striped highlight-row'>
            ...
            <tbody>
            <tr ng-if="supplierCpiVm.loading == true">
                <td colspan="14"><img src="app/assets/bower_components/cassini-platform/images/loaders/loader19.gif"
                                      class="mr5"><span translate>LOADING_CPI</span>
                </td>
            </tr>
            <tr ng-if="supplierCpiVm.loading == false && supplierCpiVm.customObjects.length == 0">
                <td colspan="12" style="background-color: #f9fbfe  !important;color: unset !important;">
                    <div class="no-data">
                        ...
                        <div class="message" translate>NO_CPI</div>
            ...
            <tr ng-repeat="object in supplierCpiVm.customObjects">
                <td class="col-width-100">
                    <a href=""
                       ng-click="supplierCpiVm.showObjectDetails(object)">{{object.number}}</a>
                </td>
