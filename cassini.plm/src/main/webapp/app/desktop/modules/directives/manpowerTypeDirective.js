define(
    ...
    function (module) {
        module.directive('manpowerTypeTree', ['$compile', '$timeout', '$translate', 'MESObjectTypeService', function ($compile, $timeout, $translate, MESObjectTypeService) {
            return {
                templateUrl: 'app/desktop/modules/directives/manpowerTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '=',
                ...
                link: function ($scope, elm, attr) {
                    ...
                    function initTree() {
                        ...
                        manufacturingTree = $('#manpowerTypeTree').tree({
                            data: [
                                {
                                    id: nodeId,
                                    text: treeNodeTitle,
