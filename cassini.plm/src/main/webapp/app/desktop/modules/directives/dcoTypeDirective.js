define(
    ...
    function (module) {
        module.directive('dcoTypeTree', ['$compile', '$timeout', 'ECOService', 'VarianceService', function ($compile, $timeout, ECOService, VarianceService) {
            return {
                templateUrl: 'app/desktop/modules/directives/dcoTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '=',
