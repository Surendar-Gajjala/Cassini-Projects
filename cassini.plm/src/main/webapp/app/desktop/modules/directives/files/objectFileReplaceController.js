define(
    ...
    function (module) {
        module.controller('ObjectFileReplaceController', ObjectFileReplaceController);

        function ObjectFileReplaceController($scope, $rootScope, $timeout, $state, $stateParams, $cookies, $translate, CommonService) {
            var vm = this;
            ...
            var qualityId = $scope.data.qualityTypeId;
            var objectType = $scope.data.qualityTypeObjectType;
            ...
            function initFilesTableDropzone() {
                ...
                var dropZone = new Dropzone(document.querySelector('#qualityReplaceFiles'), { // Make the whole body a dropzone
                    url: "api/plm/objects/" + qualityId + "/" + objectType + "/files/" + vm.file.id + "/replaceFile", // Set the url
                    thumbnailWidth: 80,
                    thumbnailHeight: 80,
                    timeout: 500000,
                ...
                dropZone.on("queuecomplete", function (progress) {
                    ...
                    if (vm.fileConfig.error) {
                        if (vm.fileConfig.fileTypeError == true && vm.fileConfig.fileSizeError == true) {
                            ...
                            $rootScope.showErrorMessage(vm.errorMessage);
                        }
                    } else {
