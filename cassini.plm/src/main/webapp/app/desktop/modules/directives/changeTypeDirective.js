define(
    ...
    function (module) {
        module.directive('changeTypeTree', ['$compile', '$timeout', 'ECOService', 'VarianceService', function ($compile, $timeout, ECOService, VarianceService) {
            return {
                templateUrl: 'app/desktop/modules/directives/changeTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '=',
                ...
                link: function ($scope, elm, attr) {
                    ...
                    function initTree() {
                        changeTree = $('#changeTypeTree').tree({
                            data: [
                                {
                                    id: nodeId,
                                    text: 'Change',
