define(
    ...
    function (module) {
        module.directive('projectManagementTypeTree', ['$compile', '$timeout', '$rootScope', 'PMObjectTypeService', function ($compile, $timeout, $rootScope, PMObjectTypeService) {
            return {
                templateUrl: 'app/desktop/modules/directives/pmObjectTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '=',
                ...
                link: function ($scope, elm, attr) {
                    ...
                    function initTree() {
                        ...
                        projectManagementTree = $('#projectManagementTypeTree').tree({
                            data: [
                                {
                                    id: nodeId,
