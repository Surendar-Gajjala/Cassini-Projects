define(
    ...
    function (module) {
        module.directive('ecrTypeTree', ['$compile', '$timeout', 'ECOService', 'VarianceService', function ($compile, $timeout, ECOService, VarianceService) {
            return {
                templateUrl: 'app/desktop/modules/directives/ecrTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '=',
