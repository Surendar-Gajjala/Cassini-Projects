<div style="padding: 20px;">
    ...
    <div class="view-tb"
         ng-if="documentReviewersVm.document.lifeCyclePhase.phaseType != 'RELEASED' && documentReviewersVm.document.lifeCyclePhase.phaseType != 'REJECTED'"
         uib-dropdown dropdown-toggle uib-dropdown-toggle>
        <span>
        ...
        <ul uib-dropdown-menu class="dropdown-menu" role="menu"
            ...
            <li>
                <div class="users-container">
                    <div class="users-search" ng-if="documentReviewersVm.logins.length > 0">
                        <input type="text" class="form-control" ng-model="documentReviewersVm.searchUsers">
                        <i class="la la-times"
                           ng-if="documentReviewersVm.searchUsers != null && documentReviewersVm.searchUsers.trim() !== ''"
                           ng-click="documentReviewersVm.searchUsers =  '';"></i>
                    </div>
                    <div class="no-users" ng-if="documentReviewersVm.logins.length == 0">
                        {{noUserSelect}}
                    </div>
                    <div class="user-cards">
                        <div class="user-card d-flex"
                             ng-repeat="login in documentReviewersVm.logins | filter: {person: {fullName: documentReviewersVm.searchUsers}}"
                             ng-click="documentReviewersVm.addReviewer(login)">
    ...
    <div class="reviewers-container">
        <div class="reviewer-card" ng-repeat="reviewer in documentReviewersVm.document.reviewers">
            <div style="display: flex;">
                ...
                <div class="reviewer-approval">
                    ...
                    <div ng-class="{'disabled':reviewer.status != 'NONE' || documentReviewersVm.document.lifeCyclePhase.phaseType == 'RELEASED' || (loginPersonDetails.external && sharedPermission == 'READ')}">
                        <input type="checkbox" id="reviewer{{$index}}" switch="none" checked=""
                               ng-click="documentReviewersVm.updateReviewer(reviewer)"
                               ng-model="reviewer.approver">
                        <label for="reviewer{{$index}}" data-on-label="Yes" data-off-label="No"></label>
                    </div>
                    <div ng-class="{'disabled':reviewer.status != 'NONE' || documentReviewersVm.document.lifeCyclePhase.phaseType == 'RELEASED' || (loginPersonDetails.external && sharedPermission == 'READ')}"
                         class="remove-approver"
                         ng-click="documentReviewersVm.deleteReviewer(reviewer)">
