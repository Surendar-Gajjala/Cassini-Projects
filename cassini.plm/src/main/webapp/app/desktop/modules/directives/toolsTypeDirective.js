define(
    ...
    function (module) {
        module.directive('toolsTypeTree', ['$compile', '$timeout', '$translate', 'MESObjectTypeService', function ($compile, $timeout, $translate, MESObjectTypeService) {
            return {
                templateUrl: 'app/desktop/modules/directives/toolsTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '=',
                ...
                link: function ($scope, elm, attr) {
                    ...
                    function initTree() {
                        ...
                        manufacturingTree = $('#toolsTypeTree').tree({
                            data: [
                                {
                                    id: nodeId,
                                    text: treeNodeTitle,
