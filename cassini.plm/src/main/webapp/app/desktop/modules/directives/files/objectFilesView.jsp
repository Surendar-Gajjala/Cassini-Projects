<div id="{{objectType}}">
    <style scoped>
        ...
        .document-model .documentModel-content {
            margin: auto;
            display: block;
            height: 260px;
            width: 500px;
    ...
    <div ng-show="showDropzone == false" id="qualityObjectFiles">
        <div class="responsive-table" id="qualityFilesTableContainer">
            <div style="display: flex;width: 100%;">
                <div id="parentFile" style="font-style: italic; text-align: center;width: 100%;padding: 10px;" dragfile
                     ...
                     ng-if="hasPermission && objectType != 'ITEM' && objectType != 'PPAPCHECKLIST' && objectType != 'TEMPLATE' && objectType != 'PROGRAMTEMPLATE' && objectType != 'TEMPLATEACTIVITY' && objectType != 'TEMPLATETASK' && hasCreate">
                ...
                <div id="parentFile1" style="font-style: italic; text-align: center;width: 100%;padding: 10px;" dragfile
                     files="files" update-file="updateFile"
                     ng-if="hasPermission && objectType == 'ITEM' && lockedOwner && hasCreate">
                    {{dragAndDropFilesTitle}}
                    <a href="" ng-click="selectFiles()">({{clickToAddFilesTitle}})</a>
                </div>
                <div style="font-style: italic; text-align: center;width: 100%;padding: 10px;"
                     ng-if="(sharedPermission == 'WRITE' && external.external == true) && objectType != 'PPAPCHECKLIST' && objectType != 'TEMPLATE' && objectType != 'PROGRAMTEMPLATE' && objectType != 'TEMPLATEACTIVITY' && objectType != 'TEMPLATETASK' && hasCreate">
                    {{dragAndDropFilesTitle}}
                    <a href="" ng-click="selectFiles()">({{clickToAddFilesTitle}})</a>
                </div>
            </div>
            ...
            <table id="itemFilesTable" class="table table-striped highlight-row">
                ...
                <tr>
                    ...
                    <th style="text-align: center;z-index: 99;" class="select-input sticky-col sticky-actions-col">

                        <div class="ckbox ckbox-default"
                             ng-show="(files.length > 0 && (objectType == 'PROGRAM' || objectType == 'PROJECT' || objectType == 'PROJECTACTIVITY' || objectType == 'PROJECTTASK'))"
                             style="display: inline-block;">
                            <input id="select-files"
                                   type="checkbox" ng-model="object.checked" ng-click="shareAllFileAndFolders()">
                            <label for="select-files" class="item-selection-checkbox"></label>
                        </div>


                    <span uib-dropdown dropdown-append-to-body style="width: 100%;"
                          ng-if="hasPermission && hasCreate && (!isExternal || (isExternal && externalPermission == 'WRITE'))"
                        ...
                        <ul uib-dropdown-menu class="dropdown-menu" role="menu" style="z-index: 9999 !important;">
                            ...
                            <li ng-if="objectType != 'DOCUMENT' && objectType != 'TEMPLATE' && objectType != 'PROGRAMTEMPLATE' && objectType != 'TEMPLATEACTIVITY' && objectType != 'TEMPLATETASK' && !isExternal">
                                <a href="" ng-click="showDocuments(null)">
                                    <span translate>ADD_DOCUMENTS</span></a>
                            </li>
                            <li ng-if="clipboardFiles.length > 0 && objectType != 'TEMPLATE' && objectType != 'PROGRAMTEMPLATE' && objectType != 'TEMPLATEACTIVITY' && objectType != 'TEMPLATETASK'">
                                <a href=""
                    ...
                    <th class="col-width-250 file-name sticky-col sticky-actions-col" style="z-index: 99;" translate>
                        TAB_FILES_FILE_NAME
                    </th>
                ...
                <tr id="{{$index}}" ng-show="showFileDropzone == false && files.length > 0"
                    ...
                    <td style="display: flex;z-index: 12;width: 70px !important;"
                    ...
                    <span ng-if="file.fileType == 'FOLDER' && hasPermission && (!isExternal || (isExternal && externalPermission == 'WRITE'))"
                        ...
                        <ul uib-dropdown-menu class="dropdown-menu" role="menu" id="folder-dropdown-{{file.id}}"
                            style="z-index: 9999 !important;">
                            <li>
                                <a href="" ng-click="addFolder(file,'Add')"
                                   translate>ADD_FOLDER</a></li>
                            <li ng-hide="objectType == 'TEMPLATE' || objectType == 'PROGRAMTEMPLATE' || objectType == 'TEMPLATEACTIVITY' || objectType == 'TEMPLATETASK'">
                            ...
                            <li ng-if="objectType != 'DOCUMENT' && objectType != 'TEMPLATE' && objectType != 'PROGRAMTEMPLATE' && objectType != 'TEMPLATEACTIVITY' && objectType != 'TEMPLATETASK'">
                         ...
                         <span style="text-align: center;width: 15px;"
                               ng-if="file.shared ==true">
                    ...
                    <td class="actions-col">
                     <span class="row-menu" uib-dropdown dropdown-append-to-body style="min-width: 50px"
                           ng-hide="file.fileType == 'FOLDER' && ((objectType == 'ITEM' && file.object != objectId) || !hasPermission)">
                           ...
                           ng-click="loadFileDropdown(file)"></i>
                            <ul uib-dropdown-menu class="dropdown-menu dropdown-menu-right" role="menu"
                                ...
                                <li title="{{hasDelete ? '' : noPermission}}"
                                    ...
                                    ng-class="{'cursor-override': !hasDelete}"
                                    ng-hide="file.lifeCyclePhase != null && file.lifeCyclePhase.phaseType != 'PRELIMINARY' && file.objectType != 'OBJECTDOCUMENT'">
                                    <a href="" ng-click="deleteFile(file)"
                                       style="color: #333 !important;"
                                       ng-class="{'disabled': !hasDelete || file.locked || !hasPermission || (objectType == 'ITEM' && file.object != objectId)}">
                                ...
                                <li ng-if="file.fileType == 'FOLDER' && hasPermission && (!isExternal || (isExternal && externalPermission == 'WRITE'))"
                                    ng-hide="(objectType == 'ITEM' && file.object != objectId) || (file.lifeCyclePhase != null && file.lifeCyclePhase.phaseType != 'PRELIMINARY')"
    ...
    <div id="document-modal" class="document-model modal">
