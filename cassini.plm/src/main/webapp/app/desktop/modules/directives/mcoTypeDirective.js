define(
    ...
    function (module) {
        module.directive('mcoTypeTree', ['$compile', '$timeout', 'ECOService', 'VarianceService', function ($compile, $timeout, ECOService, VarianceService) {
            return {
                templateUrl: 'app/desktop/modules/directives/mcoTypeDirective.jsp',
                restrict: 'E',
                replace: false,
                scope: {
                    'onSelectType': '=',
