            ...
            <div style="padding-bottom: 100px;">
                ...
                <form class="form-horizontal">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <div style="overflow: auto;padding: 5px; border: 1px solid #FFF;width: 300px;height: 200px;">
                                            <compliance-type-tree
                                                    on-select-type="newSpecificationVm.onSelectType"
                                                    object-type="PGCSPECIFICATIONTYPE"></compliance-type-tree>
                                        </div>
                                    </div>
                                </div>
                                <input type="text" class="form-control" name="title"
                                       ng-model="newSpecificationVm.type.name" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group mb15">
                                ...
                                <input type="text" class="form-control" name="title"
                                       ng-model="newSpecificationVm.newSpecification.number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" placeholder="{{'ENTER_NAME' | translate}}"
                                   name="title" ng-model="newSpecificationVm.newSpecification.name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                    ...
                    <attributes-view show-objects="selectObjectValues"
                                     ng-if="newSpecificationVm.customAttributes.length > 0"
                                     attributes="newSpecificationVm.customAttributes"></attributes-view>
                    <attributes-view show-objects="selectObjectValues"
                                     ng-if="newSpecificationVm.attributes.length > 0"
