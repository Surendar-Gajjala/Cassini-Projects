        ...
        <div class="widget-panel" style="max-height: 400px; min-height: 400px;">
            <div class="responsive-table" style="padding: 10px;">
                <table class="table table-striped highlight-row">
                    ...
                    <tr ng-if="myActivityTasksVm.loading == false && myActivityTasksVm.workflowTasks.content.length == 0">
                        <td colspan="7"><span translate>NO_TASKS</span></td>
                    </tr>
                    <tr ng-repeat="workflowTask in myActivityTasksVm.workflowTasks.content" style="font-size: 14px;">
                        <td class="name2-column">
                            <a href="" ng-click="myActivityTasksVm.showTaskDetails(workflowTask)">{{workflowTask.workflowName}}</a>
                        </td>
                        <td>
                            <span>{{workflowTask.workflowStatus}}</span>
                            <span>{{workflowTask.workflowStatus}}</span>
                        </td>
                    </tr>
                    </tbody>
