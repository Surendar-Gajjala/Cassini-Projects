  ...
  <table class="table table-striped highlight-row">
    ...
    <tr ng-repeat="workflow in workflowWigVm.workflows.content" style="font-size: 14px;">
      <td style="width: 100px;">
        <a href="" ng-click="workflowWigVm.showMfrDetails(workflow.manufacturer)">{{workflow.manufacturer.name}}</a>
      </td>
      <td style="width: 100px">{{workflow.manufacturer.mfrType.name}}</td>
      <td style="width: 100px">
        <item-status item="workflow.manufacturer"></item-status>
      </td>
