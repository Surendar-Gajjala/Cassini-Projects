<div class="responsive-table">
    <table class="table table-striped highlight-row">
        ...
        <tr ng-if="workflowWigVm.loading == false && workflowWigVm.workflows.content.length == 0">
            <td colspan="12" translate>MO_WORKFLOW</td>
        </tr>
        <tr ng-repeat="workflow in workflowWigVm.workflows.content" style="font-size: 14px;">
            <td style="width: 100px;">
                <a href="" ng-click="workflowWigVm.showEcoDetails(workflow.eco)">{{workflow.eco.ecoNumber}}</a>
            </td>
            <td style="width: 100px">{{workflow.eco.changeType}}</td>
            <td style="width: 100px">{{workflow.eco.status}}</td>
