define(
    ...
    function (module) {
        module.directive('tagsButton', TagsButtonDirective);

        function TagsButtonDirective($rootScope, $compile, $timeout, $translate) {
            return {
                templateUrl: 'app/desktop/modules/shared/tags/tagsButton.jsp',
                restrict: 'E',
                replace: true,
                scope: {
                    'objectType': '=',
