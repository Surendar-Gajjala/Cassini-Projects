<div>
    <div class='responsive-table' style="overflow-y: auto;left: 0px;top:45px;bottom: 50px;">
        <table class="table table-striped highlight-row">
            ...
            <tr ng-repeat="task in allSharesVm.sharedProjectTasks.content">
                <td style="width: 150px;">
                    <a ng-if="task.editMode == false || task.percentComplete > 0" href=""
                       ng-click="allSharesVm.showTaskDetails(task)"><span
                            ng-bind-html="task.name  | highlightText: allSharesVm.sharedObjectFilter.searchQuery"></span></a>
    <span ng-if="task.editMode == true && task.percentComplete == 0">
        <input ng-model="task.name"/>
    </span>
                </td>
                <td class="description-column"><span
                        ng-bind-html="task.description  | highlightText: allSharesVm.sharedObjectFilter.searchQuery"></span>
                </td>
    ...
    <span ng-if="task.editMode == true">
        <input type="number" class="form-control" style="width: 100px;" ng-model="task.percentComplete"/>
                ...
                <td style="width: 100px">{{task.sharedTo}}</td>
    ...
    <div class="table-footer" style="left: 0px;bottom: 10px;">
        <table-footer objects="allSharesVm.sharedProjectTasks" pageable="allSharesVm.pageable"
