<div>
    <div class='responsive-table' style="overflow-y: auto;left: 0px;top:45px;bottom: 50px;">
        <table class="table table-striped highlight-row">
            ...
            <tr ng-repeat="activity in allSharesVm.sharedProjectActivities.content">
                <td style="width: 150px;">
                    <a href="" ng-click="allSharesVm.openActivityDetails(activity)"
                       title="{{'CLICK_TO_SHOW_DETAILS' | translate}}">
                        <span ng-bind-html="activity.name  | highlightText: allSharesVm.sharedObjectFilter.searchQuery"></span>
                    </a>
                </td>
                <td class="description-column"><span
                        ng-bind-html="activity.description  | highlightText: allSharesVm.sharedObjectFilter.searchQuery"></span>
                </td>
                ...
                <td style="width: 100px">{{activity.sharedTo}}</td>
    ...
    <div class="table-footer" style="left: 0px;bottom: 10px;">
        <table-footer objects="allSharesVm.sharedProjectActivities" pageable="allSharesVm.pageable"
