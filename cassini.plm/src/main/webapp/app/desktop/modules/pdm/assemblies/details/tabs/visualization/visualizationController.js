define(
    ...
    function (module) {
        module.controller('AssemblyDetailsVisualizationController', AssemblyDetailsVisualizationController);

        function AssemblyDetailsVisualizationController($scope, $rootScope, $timeout, $state, $stateParams, $cookies, $application,
