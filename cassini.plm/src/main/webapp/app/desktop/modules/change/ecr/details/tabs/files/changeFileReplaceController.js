define(
    ...
    function (module) {
        module.controller('ChangeFileReplaceController', ChangeFileReplaceController);

        function ChangeFileReplaceController($scope, $rootScope, $timeout, $state, $stateParams, $cookies, $translate, CommonService) {
            var vm = this;
            ...
            var changeId = $scope.data.selectedChangeId;
            ...
            function initFilesTableDropzone() {
                ...
                var dropZone = new Dropzone(document.querySelector('#changeReplaceFiles'), { // Make the whole body a dropzone
                    url: "api/changes/" + changeId + "/files/" + vm.file.id + "/replaceFile", // Set the url
                    thumbnailWidth: 80,
                    thumbnailHeight: 80,
                    timeout: 500000,
