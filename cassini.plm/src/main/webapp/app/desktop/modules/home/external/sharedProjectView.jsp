<div>
    <div class='responsive-table' style="overflow-y: auto;left: 0px;bottom: 50px;">
        <table class="table table-striped highlight-row">
            ...
            <tr ng-repeat="project in externalUserVm.sharedProjects.content">
                <td style="width: 100px;">
                    <a href="" ng-click="externalUserVm.showProject(project)"
                       title="{{'CLICK_TO_SHOW_DETAILS' | translate}}">
                        <span ng-bind-html="project.name  | highlightText: externalUserVm.sharedObjectFilter.searchQuery"></span>
                    </a>
                </td>
                <td class="description-column"><span
                        ng-bind-html="project.description  | highlightText: externalUserVm.sharedObjectFilter.searchQuery"></span>
                </td>
    ...
    <div class="table-footer" style="left: 0px;bottom: 10px !important;">
        <table-footer objects="externalUserVm.sharedProjects" pageable="externalUserVm.pageable"
