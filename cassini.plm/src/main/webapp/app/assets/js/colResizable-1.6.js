...
(function ($) {
    ...
    var init = function (tb, options) {
        ...
        if (t.opt.hoverCursor !== '') h.append("<style type='text/css'>.JCLRgrip .JColResizer:hover{cursor:" + t.opt.hoverCursor + "!important}</style>");  //if hoverCursor has been set, append the style
    ...
    var createGrips = function (t) {
        ...
        th.each(function (i) {						//iterate through the table column headers
            ...
            var g = $(t.gc.append('<div class="JCLRgrip" title="Column Drag"></div>')[0].lastChild); //add the visual node to be used as grip
    ...
    $.fn.extend({
        colResizable: function (options) {
            var defaults = {
                ...
                hoverCursor: "",  		//cursor to be used on grip hover
                dragCursor: "",  		//cursor to be used while dragging
                postbackSafe: false, 			//when it is enabled, table layout can persist after postback or page refresh. It requires browsers with sessionStorage support (it can be emulated with sessionStorage.js).
                flush: true, 					//when postbakSafe is enabled, and it is required to prevent layout restoration after postback, 'flush' will remove its associated layout data
