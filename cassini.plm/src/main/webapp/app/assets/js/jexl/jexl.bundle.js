...
var Expression = function () {
  function Expression(lang, exprStr) {
  ...
  _createClass(Expression, [{
    ...
    value: function compile() {
      var lexer = new Lexer(this._lang.grammar);
      var parser = new Parser(this._lang.grammar);
    ...
    value: function _eval(context, promise) {
      ...
      return promise.resolve().then(function () {
        ...
        var evaluator = new Evaluator(_this._lang.grammar, _this._lang.transforms, context, undefined, promise);
...
},{"./Lexer":3,"./PromiseSync":4,"./evaluator/Evaluator":5,"./parser/Parser":8}],2:[function(require,module,exports){
'use strict';
...
var defaultGrammar = require('./grammar').elements;
...
var Jexl = function () {
  ...
  _createClass(Jexl, [{
    key: 'addBinaryOp',
    value: function addBinaryOp(operator, precedence, fn) {
    ...
    value: function removeOp(operator) {
      if (this._grammar[operator] && (this._grammar[operator].type === 'binaryOp' || this._grammar[operator].type === 'unaryOp')) {
...
window.jexl = new Jexl();
module.exports = new Jexl();
module.exports.Jexl = Jexl;
},{"./Expression":1,"./grammar":7}],3:[function(require,module,exports){
'use strict';
...
var Evaluator = function () {
  function Evaluator(grammar, transforms, context, relativeContext) {
    var promise = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : Promise;
  ...
  _createClass(Evaluator, [{
    ...
    value: function _filterRelative(subject, expr) {
      ...
      subject.forEach(function (elem) {
        var evalInst = new Evaluator(_this4._grammar, _this4._transforms, _this4._context, elem, _this4.Promise);
...
},{"./handlers":6}],6:[function(require,module,exports){
"use strict";
...
exports.BinaryExpression = function (ast) {
  ...
  return this.Promise.all([this.eval(ast.left), this.eval(ast.right)]).then(function (arr) {
    return _this._grammar[ast.operator].eval(arr[0], arr[1]);
  });
};
...
exports.Transform = function (ast) {
  ...
  return this.Promise.all([this.eval(ast.subject), this.evalArray(ast.args || [])]).then(function (arr) {
...
exports.UnaryExpression = function (ast) {
  ...
  return this.eval(ast.right).then(function (right) {
    return _this4._grammar[ast.operator].eval(right);
  });
};
...
},{"./handlers":9,"./states":10}],9:[function(require,module,exports){
'use strict';
