...
import com.cassinisys.plm.model.mro.QMROWorkOrder;
 ...
 */
@Component
public class WorkOrderPredicateBuilder implements PredicateBuilder<WorkOrderCriteria, QMROWorkOrder> {
    @Override
    public Predicate build(WorkOrderCriteria sparePartCriteria, QMROWorkOrder pathBase) {
        return getDefaultPredicate(sparePartCriteria, pathBase);

    }

    private Predicate getDefaultPredicate(WorkOrderCriteria criteria, QMROWorkOrder pathBase) {
