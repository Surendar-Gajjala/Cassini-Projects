...
import com.cassinisys.plm.model.mes.QMESBOP;
...
@Component
public class BOPPredicateBuilder implements PredicateBuilder<BOPCriteria, QMESBOP> {

    @Override
    public Predicate build(BOPCriteria bopCriteria, QMESBOP pathBase) {
        return getDefaultPredicate(bopCriteria, pathBase);
    }

    private Predicate getDefaultPredicate(BOPCriteria criteria, QMESBOP pathBase) {
