 ...
 */
@Component
public class DeclarationPredicateBuilder implements PredicateBuilder<DeclarationCriteria, QPGCDeclaration> {

    @Override
    public Predicate build(DeclarationCriteria declarationCriteria, QPGCDeclaration pathBase) {
        return getDefaultPredicate(declarationCriteria, pathBase);

    }

    private Predicate getDefaultPredicate(DeclarationCriteria criteria, QPGCDeclaration pathBase) {
