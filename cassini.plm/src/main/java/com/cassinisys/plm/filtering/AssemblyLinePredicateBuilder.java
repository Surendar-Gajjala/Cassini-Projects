...
import com.cassinisys.plm.model.mes.QMESAssemblyLine;
...
@Component
public class AssemblyLinePredicateBuilder implements PredicateBuilder<AssemblyLineCriteria, QMESAssemblyLine> {

    @Override
    public Predicate build(AssemblyLineCriteria assemblyLineCriteria, QMESAssemblyLine pathBase) {
        return getDefaultPredicate(assemblyLineCriteria, pathBase);

    }

    private Predicate getDefaultPredicate(AssemblyLineCriteria criteria, QMESAssemblyLine pathBase) {
