...
@Entity
@Data
@Table(name = "RM_SPECIFICATIONREVISIONSTATUSHISTORY")
public class SpecificationRevisionStatusHistory implements Serializable {

    @Id
    @SequenceGenerator(name = "ROW_ID_GEN", sequenceName = "SPECIFICATIONREVISIONSTATUSHISTORY_ID_SEQ", allocationSize = 1)
