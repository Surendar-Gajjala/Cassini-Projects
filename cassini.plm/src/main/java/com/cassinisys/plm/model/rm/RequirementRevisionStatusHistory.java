...
@Entity
@Data
@Table(name = "RM_REQUIREMENTREVISIONSTATUSHISTORY")
public class RequirementRevisionStatusHistory implements Serializable {
    @Id
    @SequenceGenerator(name = "ROW_ID_GEN", sequenceName = "REQUIREMENTREVISIONSTATUSHISTORY_ID_SEQ", allocationSize = 1)
