...
var affectedItemsDirective= function(){
    ...
    this.TestCases = function(){
        ...
        xit('Click Add button -> with select more then one Item Test case', function () {
            var plusButton = element(by.css('[ng-click="addAffectedItems()"]'));
            var EC = protractor.ExpectedConditions;
            browser.wait(EC.presenceOf(plusButton), 15000);
            plusButton.click();
            ...
            var saveAllButton = element(by.css('[ng-click="saveAll()"]'));
            var EC = protractor.ExpectedConditions;
        ...
        it('Click Edit Item button -> Edit option enable successful', function () {
            ...
            browser.sleep(1500);
            var clickonEditItemButton = element(by.css("[spellcheck='false'] > .dropdown-menu [ng-click='editItem(affectedItem)']"));
            var EC = protractor.ExpectedConditions;
            ...
            var updateButton = element(by.css('[ng-click="updateItem(affectedItem)"]'));
            var cancelButton = element(by.css('[ng-click="cancelChanges(affectedItem)"]'));
            browser.sleep(3000);
        ...
        it('Click Remove Item button -> remove that Item from the table Successful', function () {
            ...
            clickonActionButton.click();
            browser.sleep(1500);
            var clickonRemoveItemButton = element.all(by.css("[spellcheck='false'] > .dropdown-menu [ng-click='deleteAffectedItem(affectedItem)']"));
            var EC = protractor.ExpectedConditions;
...
module.exports = new affectedItemsDirective();
