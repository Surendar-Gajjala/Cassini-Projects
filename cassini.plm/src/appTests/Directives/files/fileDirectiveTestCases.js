...
var fileDirectiveTestCases= function(){
    ...
    this.filesTab = function(){
        ...
        it('Check New Folder creation->with entering mandatory fields data', function () {
            ...
            browser.wait(EC.presenceOf(urlsPage.byModel('newFolderVm.newFolder.name').sendKeys('Folder102')), 35000);
            browser.sleep(3500);
...
module.exports = new fileDirectiveTestCases();
