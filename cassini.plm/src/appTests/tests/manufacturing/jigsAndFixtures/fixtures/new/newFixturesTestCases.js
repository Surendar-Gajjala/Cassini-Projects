var urlsPage = require('../../../../../pages/urlsPage.js');
 ...
 //-------Check New Fixture creation->without entering mandatory fields data----------
 describe('Check New Fixture creation->without entering mandatory fields data', function () {
    ...
    it('Without Asset Type ', function () {
        ...
        browser.wait(EC.presenceOf(urlsPage.byModel('newJigsAndFixturesVm.newJigAndFix.name').sendKeys('Fixture 27')), 35000);
        browser.sleep(2000);
...
//-------Check New Fixture creation->with entering mandatory fields data----------
describe('Check New Fixture creation->by entering mandatory fields data', function () {
    ...
    it(' New Fixture create Successfull Test Case', function () {
        var selectFixtureType = element(by.id('fixtureType'));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(selectFixtureType), 15000);
        selectFixtureType.click();
        ...
        browser.wait(EC.presenceOf(urlsPage.byModel('newJigsAndFixturesVm.newJigAndFix.name').sendKeys('Fixture 13013')), 35000);
        ...
        browser.wait(EC.presenceOf(urlsPage.byModel('asset.name').sendKeys('Assert 13013')), 35000);
        ...
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(alertMessage), 5000, "Text is not something I've expected");
        expect(alertMessage).toEqual('Fixture created successfully');
        browser.sleep(8000);
    });
