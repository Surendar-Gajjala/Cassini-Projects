var urlsPage = require('../../../../pages/urlsPage.js');
 ...
 //-------Check New Tool creation->without entering mandatory fields data----------
 describe('Check New Tool creation->without entering mandatory fields data', function () {
    ...
    it('With Out Tool Type', function () {
    ...
    it('With Out Tool Name', function () {
    ...
    it('With Out Asset Type ', function () {
        ...
        browser.wait(EC.presenceOf(urlsPage.byModel('newToolVm.newTool.name').sendKeys('Tool 27')), 35000);
        browser.sleep(2000);
...
//-------Check New Tool creation->with entering mandatory fields data----------
describe('Check New Tool creation->by entering mandatory fields data', function () {
    ...
    it(' New Tool create Successfull Test Case', function () {
        var newButton = element(by.css('.new-button'));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(newButton), 15000);
        newButton.click();
        ...
        browser.wait(EC.presenceOf(urlsPage.byModel('newToolVm.newTool.name').sendKeys('Tool 505585887')), 35000);
        ...
        browser.wait(EC.presenceOf(urlsPage.byModel('asset.name').sendKeys('Assert 502988868')), 35000);
        ...
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(alertMessage), 5000, "Text is not something I've expected");
        expect(alertMessage).toEqual('Tool created successfully');
        browser.sleep(8000);
    });
