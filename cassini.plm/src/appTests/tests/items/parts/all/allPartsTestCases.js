...
describe('Part Module',function(){
    beforeAll(function(){
        browser.get(urlsPage.allPartsItems);
        browser.sleep(5000);
    });

    it('Check Part tab in the side navigation', function () {
        ...
        itemsButton.click();
        var partitemsButton = element(by.id('partitems'));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(partitemsButton), 25000);
        partitemsButton.click();
        browser.sleep(15000);
        expect(browser.getCurrentUrl()).toEqual(urlsPage.allPartsItems);
        browser.sleep(5000);
    });


    it('new Part button click',function(){
    ...
    it('closed side pannel when we click close button(x)',function() {
        ...
        expect(newButton.getText()).toEqual('New Part');
        browser.sleep(8000);
    });
