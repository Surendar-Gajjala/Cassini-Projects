...
describe('Items Module',function(){
    beforeAll(function(){
        browser.get(urlsPage.allDocumentsItems);
        browser.sleep(5000);
    });
    ...
    it('Check Item tab in the side navigation', function () {
        ...
        itemsButton.click();
        var documentitemsButton = element(by.id('document-items'));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(documentitemsButton), 25000);
        documentitemsButton.click();
        browser.sleep(15000);
        expect(browser.getCurrentUrl()).toEqual(urlsPage.allDocumentsItems);
        browser.sleep(5000);
    });
    ...
    it('closed side pannel when we click close button(x)',function() {
        ...
        expect(newButton.getText()).toEqual('New Document');
        browser.sleep(8000);
    });
