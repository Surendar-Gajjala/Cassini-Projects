...
describe('Products Module',function(){
    beforeAll(function(){
        browser.get(urlsPage.allProductsItems);
        browser.sleep(5000);
    });
    ...
    it('Check Item tab in the side navigation', function () {
        ...
        itemsButton.click();
        var productitemsButton = element(by.id('product-items'));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(productitemsButton), 25000);
        productitemsButton.click();
        browser.sleep(15000);
        expect(browser.getCurrentUrl()).toEqual(urlsPage.allProductsItems);
        browser.sleep(5000);
    });
    ...
    it('closed side pannel when we click close button(x)',function() {
        ...
        expect(newButton.getText()).toEqual('New Product');
        browser.sleep(8000);
    });
