...
describe('Design Data -> Drawings:', function () {

    //---------Check Design Data Drawings tab in the side navigation -------
    it('Check Drawings tab in the side navigation', function () {
