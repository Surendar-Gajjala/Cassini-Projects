...
describe('Dashboards -> Workflow', function () {
  ...
  //---------Check Dashboards Workflow tab in the side navigation -------
  it('Check Dashboards Workflow tab in the side navigation', function () {
