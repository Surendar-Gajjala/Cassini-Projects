...
describe('Deviation Details -> Workflow tab:', function () {
    ...
    it('Click on Workflow tab -> open the  Workflow tab View successfully', function () {
        ...
        filesTab.click();
        expect(browser.getCurrentUrl()).toBe(urlsPage.baseUrl + 'changes/variance/' + urlsPage.url_id + '?tab=details.workflow');
        browser.sleep(5000);
    });
