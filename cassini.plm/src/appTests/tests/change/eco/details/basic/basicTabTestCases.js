...
//---------Click Eco Number hyperlink -> goto Basic details tab Successfully-------------
it('Click Eco Number hyperlink -> goto Basic details tab Successfully', function () {
    browser.get(urlsPage.allEcos);
    browser.sleep(8000);
    var number = element.all(by.css("[ng-click='ecosVm.showEcoDetails(change)']")).first();
    ...
    browser.getCurrentUrl().then(function (url) {
        urlsPage.url_id = url.split("eco/")[1].replace("?tab=details.basic","");
        browser.sleep(3000);
        expect(browser.getCurrentUrl())
            .toEqual(urlsPage.baseUrl+'changes/eco/'+urlsPage.url_id+'?tab=details.basic');
    });

    browser.sleep(5000);
});

describe('ECO Details -> Basic -> Check data update with Cancel option', function () {

    beforeAll(function () {
        browser.get(urlsPage.baseUrl + 'changes/eco/' +  urlsPage.url_id + '?tab=details.basic');
        browser.sleep(5000);
    });
    beforeEach(function () {
        browser.sleep(500);
    ...
    it('Title Field', function () {
        ...
        var beforeTitleValue = element(by.css("[editable-text='ecoBasicVm.eco.title']"));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(beforeTitleValue), 15000);

        var editClick = element(by.css("[editable-text='ecoBasicVm.eco.title']"));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(editClick), 15000);
        editClick.click();
        browser.sleep(1000);

        browser.wait(EC.presenceOf(urlsPage.byModel('$parent.$data').clear().sendKeys('Eco 275')), 35000);
        ...
        browser.sleep(1500);
        var afterTitleValue = element(by.css("[editable-text='ecoBasicVm.eco.title']"));
        var EC = protractor.ExpectedConditions;
    ...
    it('Description Field', function () {
        ...
        var beforeDescriptionValue = element(by.css("[editable-textarea='ecoBasicVm.eco.description']"));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(beforeDescriptionValue), 15000);

        var editClick = element(by.css("[editable-textarea='ecoBasicVm.eco.description']"));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(editClick), 15000);
        editClick.click();
        browser.sleep(1000);
        ...
        browser.sleep(1500);
        var afterDescriptionValue = element(by.css("[editable-textarea='ecoBasicVm.eco.description']"));
        var EC = protractor.ExpectedConditions;
    ...
    it('Reason for Change Field', function () {
        ...
        var beforeReasonForChangeValue = element(by.css("[editable-textarea='ecoBasicVm.eco.reasonForChange']"));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(beforeReasonForChangeValue), 15000);

        var editClick = element(by.css("[editable-textarea='ecoBasicVm.eco.reasonForChange']"));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(editClick), 15000);
        editClick.click();
        browser.sleep(1000);
        ...
        browser.sleep(1500);
        var afterReasonForChangeValue = element(by.css("[editable-textarea='ecoBasicVm.eco.reasonForChange']"));
        var EC = protractor.ExpectedConditions;
...
describe('ECO Details -> Basic -> Check data update with OK option', function () {
    ...
    it('Title Field', function () {
        ...
        browser.wait(EC.presenceOf(urlsPage.byModel('$parent.$data').clear().sendKeys('Eco 27')), 35000);
        ...
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(alertMessage), 5000, "Text is not something I've expected");
        expect(alertMessage).toEqual('ECO updated successfully');
        browser.sleep(5000);
    ...
    it('Change Analyst Field', function () {
        ...
        var editClick = element(by.css("[editable-select='ecoBasicVm.eco.ecoOwnerObject']"));
        var EC = protractor.ExpectedConditions;
        browser.wait(EC.presenceOf(editClick), 15000);
        editClick.click();
        browser.sleep(1000);
