...
describe('DCR Details -> Affected Items tab:', function () {
    beforeAll(function () {
        browser.refresh();
        browser.sleep(8000);
    });
    ...
    it('Click on Affected Items tab -> open the  Affected Items tab View successfully', function () {
        ...
        filesTab.click();
        expect(browser.getCurrentUrl()).toBe(urlsPage.baseUrl + 'changes/dcr/' + urlsPage.url_id + '?tab=details.affectedItems');
        browser.sleep(5000);
    });
