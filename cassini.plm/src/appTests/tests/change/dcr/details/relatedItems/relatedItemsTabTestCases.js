...
describe('DCR Details ->  Related Items tab:', function () {
    beforeAll(function () {
        browser.refresh();
        browser.sleep(8000);
    });
    ...
    it('Click on Related Items tab -> open the  Related Items tab View successfully', function () {
        ...
        filesTab.click();
        expect(browser.getCurrentUrl()).toBe(urlsPage.baseUrl + 'changes/dcr/' + urlsPage.url_id + '?tab=details.relatedItems');
        browser.sleep(5000);
    });
