...
//---------Click Item Inspection  Number hyperlink -> goto Basic details tab Successfully-------------
it('Click Item Inspection  Number hyperlink -> goto Basic details tab Successfully', function () {
...
describe('Item Inspection Details -> Basic -> Check data update with Cancel option', function () {
...
describe('Item Inspection Details -> Basic -> Check data update with OK option', function () {
...
it('Item Inspection Details -> Basic -> Click on Inspection Plan -> go to the Inspection plan Basic details  page',function() {
