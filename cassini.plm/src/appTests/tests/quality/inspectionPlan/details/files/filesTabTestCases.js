...
describe('Inspection Plan Details -> Files:', function () {
    ...
    it('Click on Files tab -> open the files tab View successfully', function () {
        ...
        filesTab.click();
        expect(browser.getCurrentUrl()).toBe(urlsPage.baseUrl + 'pqm/inspectionPlan/' + urlsPage.url_id + '?tab=details.files');
        browser.sleep(5000);
    });
