    ...
    function (module) {
        ...
        function FolderService(httpFactory) {
            ...
            function getFolderTree() {
                var url = "api/dm/folders/tree";
                return httpFactory.get(url);
            }

            function deleteFolderDocument(folderId, documentId) {
                var url = "api/dm/folders/" + folderId + "/documents/" + documentId;
                return httpFactory.delete(url);
            }
