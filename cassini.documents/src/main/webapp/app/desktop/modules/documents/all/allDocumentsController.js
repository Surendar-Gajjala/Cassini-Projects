define(['app/desktop/modules/documents/document.module',
    ...
    function (module) {
        ...
        function AllDocumentsController($scope, $rootScope, $timeout, $window, $state, $uibModal, $stateParams, $cookies,
                                        DocumentService, FolderService, CommonService, DialogService, RoleService, LoginService) {
            ...
            function selectPermissions() {
                ...
                angular.forEach(vm.roles, function (projectRole) {
            ...
            function loadRoles() {
                RoleService.getRolesAll($stateParams.projectId).then(
                    function (data) {
                        vm.roles = data;
                    });
            }
                ...
                if (data != null && data.attributes.folder != null) {
                    ...
                    angular.forEach(vm.roles, function (role) {
                        role.allSelected = role.noneSelected = role.writeSelected =
                            role.readSelected = role.deleteSelected = false;
                    });
                    angular.forEach(vm.persons, function (person) {
            ...
            function showFileHistory(fileId) {
                var options = {
                    title: 'File History',
                    template: 'app/desktop/modules/documents/all/documentFileHistoryView.jsp',
