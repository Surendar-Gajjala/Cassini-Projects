...
<div class="view-container" fitcontent>
    ...
    <div class="view-toolbar">
        <div class="col-sm-10" ng-hide="allDocumentsVm.selectedFolder == null">
        ...
        <h4 style="text-align:right; margin-right:10px;margin-top:4px;text-overflow: ellipsis;white-space: nowrap;overflow: hidden;" title="{{allDocumentsVm.selectedFolder.name}}">
            {{allDocumentsVm.selectedFolder.name}}
        </h4>
    </div>

    <div class="view-content no-padding" style="overflow-y: auto;">
        <div id="contextMenu" class="context-menu dropdown clearfix" ng-if="allDocumentsVm.hasPermission('addFolder') == true || allDocumentsVm.hasPermission('deleteFolder') == true"
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu" style="">
                <li><a tabindex="-1" href="" ng-click="allDocumentsVm.addFolder()"
                       ng-disabled="!(allDocumentsVm.hasPermission('addFolder') || allDocumentsVm.loginPerson.create || allDocumentsVm.loginPerson.write || allDocumentsVm.loginPerson.isAdmin)">Add Folder</a></li>
                <li><a tabindex="-1" href="" ng-click="allDocumentsVm.deleteFolder()" ng-if="allDocumentsVm.hasPermission('deleteFolder') == true || allDocumentsVm.loginPerson.isAdmin"
        ...
        <div class="split-pane fixed-left">
            ...
            <div class="split-pane-component split-right-pane noselect" style="left:300px;" id="files-pane">
                ...
                <div ng-hide="allDocumentsVm.selectedFolder == null && allDocumentsVm.showDropzone == false && !allDocumentsVm.permission" id="dropzoneForm">
                    <div style="font-style: italic; text-align: center;margin-bottom: 20px;" ng-if="!allDocumentsVm.permission" ng-hide="!(allDocumentsVm.showDocumentsButton || allDocumentsVm.loginPerson.isAdmin || allDocumentsVm.loginPerson.write || allDocumentsVm.loginPerson.all || allDocumentsVm.loginPerson.create)">
                        Drag and drop files on to the table or <a href="" ng-click="allDocumentsVm.selectFiles()">(Click here to add
                        files)</a>
                    </div>
                    <div style="background-color: indianred;color: white; text-align: center; line-height: 35px;" ng-if="allDocumentsVm.hasError" >
                        {{allDocumentsVm.message}} files were locked, cannot upload these files
                        <span style="color: white; opacity: 0.6; padding: 5px;" class="close" ng-click="allDocumentsVm.closeNotification()">x</span>
                    </div>
                    <div>
                    ...
                    <div id="itemFilesTableContainer" ng-hide="allDocumentsVm.selectedFolder == null">
                        <div class="responsive-table" ng-if="!allDocumentsVm.permission">
                            <table class="table table-striped highlight-row">
                                ...
                                <tr ng-if="allDocumentsVm.documents.length > 0 && allDocumentsVm.loading == false"
                                    ...
                                    <td style="text-align: center">{{allDocumentsVm.fileSizeToString(document.size)}}</td>
                                    ...
                                    <td style="text-align: center">
                                        <input type="checkbox" ng-model="document.locked" ng-disabled="!(allDocumentsVm.loginPerson.isAdmin || (document.enableLockButton) || allDocumentsVm.loginPerson.all || allDocumentsVm.loginPerson.write)"
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group" style="display: inline-flex">
                                            ...
                                            <button class="btn btn-xs btn-warning" title="Show file history"
                                                    ng-click="allDocumentsVm.showFileHistory(document.id)"><i class="fa fa-copy"></i>
                                            </button>
                                            <button title="Download document"
                                                    class="btn btn-xs btn-primary"  ng-disabled="!(allDocumentsVm.loginPerson.all || allDocumentsVm.loginPerson.read || allDocumentsVm.loginPerson.isAdmin)"
                                                    ng-click="allDocumentsVm.downloadDocument(document)">
                                                <i class="fa fa-download"></i>
                                            </button>
                                            <button title="Delete document" ng-if="document.locked == false"
                                                    ng-disabled="!(allDocumentsVm.loginPerson.all || allDocumentsVm.loginPerson.isAdmin || document.locked || allDocumentsVm.loginPerson.delete)"
                                                    class="btn btn-xs btn-danger"
                                                    ng-click="allDocumentsVm.deleteDocument(document)"><i
                                                    class="fa fa-trash"></i>
                                            </button>
                ...
                <div ng-show="allDocumentsVm.permission">
