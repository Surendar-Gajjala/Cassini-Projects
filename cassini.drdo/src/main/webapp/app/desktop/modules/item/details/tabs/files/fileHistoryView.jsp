        ...
        <div class="comments-panel">
            <ul class="timeline">
                <li ng-repeat="fileVersion in fileHistoryVm.fileVersions">
                    <div class="direction-r">
                        ...
                        <span class="time-wrapper">
                            <span class="time" style="font-size: 14px;">
                             {{fileVersion.createdDate}} ( <span style="color: black;font-style: italic;">{{fileVersion.createdByObject.firstName}}</span> )
                            </span>
                            <span>
                            <i class="fa" ng-click="fileHistoryVm.showComment(fileVersion)"
                               ng-if="fileVersion.comments.length > 0"
                               title="{{fileVersion.showComments ? 'Click to hide comments' : 'Click to show comments'}}"
                    ...
                    <h6 ng-if="fileVersion.comments.length == 0" style="width: 300px;margin: 0px;">File Version has
                        No Comments</h6>
                </li>
            </ul>
        </div>
        <div class="comment-input"
             style="margin-left: -10px;padding: 5px 10px 10px !important;height: 50px !important;">
            <div class="input-group">
                <textarea class="form-control" rows="1" placeholder="Enter comment"
                          ng-model="fileHistoryVm.newComment.comment" style="height: 41px;resize: none"></textarea>
        ...
        <div class="comments-panel">
            <ul class="timeline">
                <li ng-repeat="fileVersion in fileHistoryVm.fileVersions">
                    <div class="direction-r">
                        ...
                        <span class="time-wrapper">
                            ...
                            <i class="fa fa-download" ng-if="fileVersion.downloadHistories.length > 0"
                               title="{{fileVersion.showDownloads ? 'Click to hide Downloads' : 'Click to show Downloads'}}"
                    ...
                    <h6 ng-if="fileVersion.downloadHistories.length == 0" style="width: 300px;margin: 0px;">File Version
                        has
                        No Downloads</h6>
                </li>
            </ul>
