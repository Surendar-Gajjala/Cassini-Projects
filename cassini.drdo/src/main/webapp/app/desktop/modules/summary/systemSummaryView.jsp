                    ...
                    <div class="row">
                        <div class="col-sm-10" style="height: 100% !important;border-right: 2px solid #fff;">
                            <div style="width: 100%;height: 70px;">
                                <h2 style="margin: 0;line-height: 70px;color: #fff;">Missiles Completed</h2>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div style="width: 100%;height: 70px;">
                                <h1 style="margin: 0;line-height: 70px;color: #fff;">{{summaryVm.systemSummary.missilesCompleted}}</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                <div class="panel panel-summary panel-inprogress">
                    <div class="row">
                        <div class="col-sm-10" style="height: 100% !important;border-right: 2px solid #fff;">
                            <div style="width: 100%;height: 70px;">
                                <h2 style="margin: 0;line-height: 70px;color: #fff;">Missiles In Progress</h2>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div style="width: 100%;height: 70px;">
                                <h1 style="margin: 0;line-height: 70px;color: #fff;">{{summaryVm.systemSummary.missilesInProgress}}</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                <div class="panel panel-summary panel-notyetstarted">
                    <div class="row">
                        <div class="col-sm-10" style="height: 100% !important;border-right: 2px solid #fff;">
                            <div style="width: 100%;height: 70px;">
                                <h2 style="margin: 0;line-height: 70px;color: #fff;">Missiles Not Yet Started</h2>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div style="width: 100%;height: 70px;">
                                <h1 style="margin: 0;line-height: 70px;color: #fff;">{{summaryVm.systemSummary.missilesNotYetStarted}}</h1>
                            </div>
                        </div>
                    </div>
                </div>
