            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td style="width:250px;">
                        <table-filter placeholder="Cost" filters="filters"
                                      property="shippingCost" apply-filters="applyFilters()"/>
                    </td>

                    <td style="width: 200px; text-align: right">
                        <table-filter placeholder="LR Number" filters="filters" property="confirmationNumber"
                                      apply-filters="applyFilters()"/>
                    </td>
                    <td style="width: 150px; text-align: right">
                        <table-filter placeholder="Vehicle" filters="filters" property="vehicle"
                                      apply-filters="applyFilters()"/>
                    </td>
                    <td style="width: 150px; text-align: right">
                        <table-filter placeholder="Driver" filters="filters" property="driver"
                                      apply-filters="applyFilters()"/>
                    </td>
                    <td style="width:250px;">
                    ...
                    <td style="width:250px;">
                        <ui-select ng-model="filters.paidBy" on-select="applyFilters()" theme="bootstrap"
                                   style="width:100%">
                            <ui-select-match allow-clear="true" placeholder="Type">{{$select.selected}}
                            </ui-select-match>
                    ...
                    <td style="width: 150px; text-align: right">
                        <table-filter placeholder="Value" align="right" filters="filters" property="value"
                                      apply-filters="applyFilters()"/>
                    </td>
                </tr>
                ...
                <tr ng-repeat="consignment in consignments.content"
                    ...
                    <td style="text-align: center;width: 250px;">
                        <a href="#" ng-if="consignment.paidBy == 'SELF'" editable-text="consignment.shippingCost"
                           title="Click to edit"
                    ...
                    <td style="text-align: center">
                        ...
                        <a href="#" ng-if="consignment.shipper.name == 'Self' &&
                                            consignment.confirmationNumber == null &&
                                            consignment.vehicle != null &&
                                            consignment.driver != null"
                           ng-click="consignment.confirmationNumber = 'BR'; updateConsignment(consignment)">
                            Click to confirm
                        </a>
                    ...
                    <%--<td ng-if="!shipment.showDetails" style="width: 200px">{{consignment.order.poNumber}}</td>--%>
