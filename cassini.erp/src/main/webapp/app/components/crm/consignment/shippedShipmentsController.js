define(['app/app.modules',
    ...
    function ($app) {
        $app.controller('ShippedShipmentsController',
            [
                ...
                function ($scope, $rootScope, $timeout, $interval, $state, $cookies, $modal,
                    ...
                    $rootScope.viewTitle = "Shipped Shipments";

                    $scope.vehicles = [];
                    $scope.employees = [];
                    $scope.showInvoice = false;
                    $scope.showPONumber = false;
                    ...
                    $scope.hoverIn = function(trNumber){
                        $scope.showtrNumber = trNumber;
                    ...
                    $scope.hoverInPos = function(trNumber){
                        $scope.showtrNumber = trNumber;
                        $scope.showPONumber = true;
                    }

                    $scope.hoverOutPos = function(){
                        $scope.showPONumber = false;
                    }
