define(['app/app.modules',
    ...
    function ($app) {
        $app.controller('EmployeesShiftSelectionController',
            [
                ...
                function ($scope, $rootScope, $timeout, $interval, $state, $cookies,
                    ...
                    $scope.dialogTitle = (dialogTitle != undefined || dialogTitle != null) ? dialogTitle : "Select Employees For Shift";
                    ...
                    $scope.ok = function () {
                        $modalInstance.close($scope.employees);
                    };
