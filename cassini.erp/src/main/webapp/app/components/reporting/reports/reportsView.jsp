        ...
        <div class="col-sm-3 styled-panel" style="height: 100%;padding-top: 10px;">
            <div class="row">
                <div class="form-group col-sm-12" style="padding: 0">
                    ...
                    <ui-select ng-model="selectedModule" on-select="onSelectModule($item, $model)" theme="bootstrap" style="width: 100%;" title="Select a module">
        ...
        <div class="col-sm-9" style="height: 100%; padding-left: 10px">
            <div class="styled-panel" style="height: 100%;">
                <div class="row reports-container"
                    ...
                    <div ng-if="selectedReport.id == 'builtin.reports.book-sales'"
                         ng-controller="BookSalesReportController"
                         ng-include="selectedReport.template">
                    </div>
                    <div ng-if="selectedReport.id == 'builtin.reports.daily-sales'"
                         ng-controller="DailySalesReportController"
                         ng-include="selectedReport.template">
                    </div>
                    <div ng-if="selectedReport.id == 'builtin.reports.product-vs-sample'"
                         ng-controller="ProductVsSampleSalesController"
                         ng-include="selectedReport.template">
                    </div>
                </div>
            </div>
