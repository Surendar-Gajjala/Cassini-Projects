<div ng-controller="LoginRolesController">
    <br/>
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-12"
            ...
            <div class="alert alert-warning" ng-if="selectedLogin.loginName == 'admin'">
                <i class="fa fa-warning mr10"></i>Roles for super admin cannot be modified!
            </div>

            <div class="alert alert-warning" ng-if="canModifyOtherAdmin() == false" >
                            ...
                            <td>
                                <div ng-if="chunk[1].name != null">
                                    <input id="roleChk{chunk[1].id}" type="checkbox" ng-model="chunk[1].selected"
                                           ng-disabled="isRoleDisabled(chunk[1])"/>
                                    <label for="roleChk{chunk[1].id}"
                                           ng-disabled="isRoleDisabled(chunk[1])">{{chunk[1].name}}</label>
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div style="text-align: center">
                ...
                <button class="btn btn-sm btn-primary" ng-click="saveLoginRoles()"
                        ng-if="selectedLogin.loginName != 'admin'">Save</button>
            </div>
        </div>
    </div>
</div>