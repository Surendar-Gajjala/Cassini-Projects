<div class="row" style="margin-bottom: 0px">
    <div class="col-md-12"  style="text-align: right" ng-show="orders.numberOfElements > 0">
    ...
    <div class="col-md-12 responsive-table">
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td style="text-align:center;width: 150px;" ng-class="{hasFilter: ((filters.orderType != null && filters.orderType != ''))}">
                ...
                <td style="text-align:center;width: 150px;" ng-class="{hasFilter: ((filters.status != null && filters.status != ''))}">
            ...
            <tr ng-repeat="order in orders.content"
                ...
                <td class="col-center actions-col">
                    <div class="btn-group" dropdown style="margin-bottom: 0px;" fix-drop-down>
                ...
                <td style="width: 120px">
                    ...
                    <span ng-if="order.starred == true" style="margin-left: 10px"><i class="fa fa-star-o"></i></span>
