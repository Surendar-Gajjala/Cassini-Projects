...
hibernate.tenant_identifier_resolver=com.cassinisys.erp.config.CassiniTenantIdentifierResolver
hibernate.multi_tenant_connection_provider=com.cassinisys.erp.config.CassiniTenantConnectionProvider

# cassini properties
cassini.tenants=cassini
cassini.fs.root=/Users/reddy/Temp/cassinisys/cassini.erp
